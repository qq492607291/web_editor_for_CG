...
define("EW_PROJECT_NAME", "ks_codemaker", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{5DAF7451-EE21-4ABF-A979-870614CA82FC}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '4uv9QWuUq4i3F1qP', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/ks_codemaker.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 6606, "user" => "root", "pass" => "taotao@0714", "db" => "ks_codemaker", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`ksdb_user`", TRUE);

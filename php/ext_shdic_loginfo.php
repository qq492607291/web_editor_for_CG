...
//
// Table class for ext_shdic_log
//
class cext_shdic_log extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $ExtId;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_shdic_log';
		$this->TableName = 'ext_shdic_log';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_shdic_log`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_shdic_log', 'ext_shdic_log', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_shdic_log', 'ext_shdic_log', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_shdic_log', 'ext_shdic_log', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ExtId
		$this->ExtId = new cField('ext_shdic_log', 'ext_shdic_log', 'x_ExtId', 'ExtId', '`ExtId`', '`ExtId`', 201, -1, FALSE, '`ExtId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ExtId->Sortable = TRUE; // Allow sort
		$this->fields['ExtId'] = &$this->ExtId;

		// ExtType
		$this->ExtType = new cField('ext_shdic_log', 'ext_shdic_log', 'x_ExtType', 'ExtType', '`ExtType`', '`ExtType`', 201, -1, FALSE, '`ExtType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ExtType->Sortable = TRUE; // Allow sort
		$this->fields['ExtType'] = &$this->ExtType;

		// Name
		$this->Name = new cField('ext_shdic_log', 'ext_shdic_log', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// C
		$this->C = new cField('ext_shdic_log', 'ext_shdic_log', 'x_C', 'C', '`C`', '`C`', 201, -1, FALSE, '`C`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->C->Sortable = TRUE; // Allow sort
		$this->fields['C'] = &$this->C;

		// K
		$this->K = new cField('ext_shdic_log', 'ext_shdic_log', 'x_K', 'K', '`K`', '`K`', 201, -1, FALSE, '`K`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->K->Sortable = TRUE; // Allow sort
		$this->fields['K'] = &$this->K;

		// V
		$this->V = new cField('ext_shdic_log', 'ext_shdic_log', 'x_V', 'V', '`V`', '`V`', 201, -1, FALSE, '`V`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->V->Sortable = TRUE; // Allow sort
		$this->fields['V'] = &$this->V;

		// Trigger
		$this->Trigger = new cField('ext_shdic_log', 'ext_shdic_log', 'x_Trigger', 'Trigger', '`Trigger`', '`Trigger`', 201, -1, FALSE, '`Trigger`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Trigger->Sortable = TRUE; // Allow sort
		$this->fields['Trigger'] = &$this->Trigger;

		// TR_Limit
		$this->TR_Limit = new cField('ext_shdic_log', 'ext_shdic_log', 'x_TR_Limit', 'TR_Limit', '`TR_Limit`', '`TR_Limit`', 201, -1, FALSE, '`TR_Limit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->TR_Limit->Sortable = TRUE; // Allow sort
		$this->fields['TR_Limit'] = &$this->TR_Limit;

		// Function
		$this->Function = new cField('ext_shdic_log', 'ext_shdic_log', 'x_Function', 'Function', '`Function`', '`Function`', 201, -1, FALSE, '`Function`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Function->Sortable = TRUE; // Allow sort
		$this->fields['Function'] = &$this->Function;

		// DATETIME
		$this->DATETIME = new cField('ext_shdic_log', 'ext_shdic_log', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_shdic_log`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_shdic_logedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_shdic_logadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_shdic_logview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_shdic_logview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_shdic_logadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_shdic_logadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_shdic_logedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_shdic_logadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_shdic_logdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->ExtId->setDbValue($rs->fields('ExtId'));
		$this->ExtType->setDbValue($rs->fields('ExtType'));
	...
	function RenderEditRow() {
		...
		$this->ExtId->EditValue = $this->ExtId->CurrentValue;
		...
		$this->ExtType->EditValue = $this->ExtType->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->ExtId->Exportable) $Doc->ExportCaption($this->ExtId);
					if ($this->ExtType->Exportable) $Doc->ExportCaption($this->ExtType);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->ExtId->Exportable) $Doc->ExportField($this->ExtId);
						if ($this->ExtType->Exportable) $Doc->ExportField($this->ExtType);

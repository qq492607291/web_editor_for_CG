...
$ext_sam_base_info = NULL;

//
// Table class for ext_sam_base_info
//
class cext_sam_base_info extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_sam_base_info';
		$this->TableName = 'ext_sam_base_info';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_sam_base_info`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// LV
		$this->LV = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_LV', 'LV', '`LV`', '`LV`', 201, -1, FALSE, '`LV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LV->Sortable = TRUE; // Allow sort
		$this->fields['LV'] = &$this->LV;

		// MainCat
		$this->MainCat = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_MainCat', 'MainCat', '`MainCat`', '`MainCat`', 201, -1, FALSE, '`MainCat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MainCat->Sortable = TRUE; // Allow sort
		$this->fields['MainCat'] = &$this->MainCat;

		// SubCat
		$this->SubCat = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_SubCat', 'SubCat', '`SubCat`', '`SubCat`', 201, -1, FALSE, '`SubCat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->SubCat->Sortable = TRUE; // Allow sort
		$this->fields['SubCat'] = &$this->SubCat;

		// Location
		$this->Location = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_Location', 'Location', '`Location`', '`Location`', 201, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Dialog
		$this->Dialog = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_Dialog', 'Dialog', '`Dialog`', '`Dialog`', 201, -1, FALSE, '`Dialog`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Dialog->Sortable = TRUE; // Allow sort
		$this->fields['Dialog'] = &$this->Dialog;

		// Function
		$this->Function = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_Function', 'Function', '`Function`', '`Function`', 201, -1, FALSE, '`Function`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Function->Sortable = TRUE; // Allow sort
		$this->fields['Function'] = &$this->Function;

		// Introduce
		$this->Introduce = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_Introduce', 'Introduce', '`Introduce`', '`Introduce`', 201, -1, FALSE, '`Introduce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Introduce->Sortable = TRUE; // Allow sort
		$this->fields['Introduce'] = &$this->Introduce;

		// DATETIME
		$this->DATETIME = new cField('ext_sam_base_info', 'ext_sam_base_info', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_sam_base_info`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ext_sam_base_infolist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_sam_base_infoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_sam_base_infoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_sam_base_infoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_sam_base_infoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_sam_base_infoadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_sam_base_infoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_sam_base_infoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_sam_base_infoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_sam_base_infodelete.php", $this->UrlParm());
	}

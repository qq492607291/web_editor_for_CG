...
$config_task_add = NULL; // Initialize page object first

class cconfig_task_add extends cconfig_task {
	...
	// Page object name
	var $PageObjName = 'config_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_taskview.php")
	...
	function LoadDefaultValues() {
		...
		$this->ResetTime->CurrentValue = NULL;
		$this->ResetTime->OldValue = $this->ResetTime->CurrentValue;
		$this->ResetType->CurrentValue = NULL;
		$this->ResetType->OldValue = $this->ResetType->CurrentValue;
		$this->CompleteTask->CurrentValue = NULL;
		$this->CompleteTask->OldValue = $this->CompleteTask->CurrentValue;
		...
		$this->Reward_Diamonds->CurrentValue = NULL;
		$this->Reward_Diamonds->OldValue = $this->Reward_Diamonds->CurrentValue;
		...
		$this->Info->CurrentValue = NULL;
		$this->Info->OldValue = $this->Info->CurrentValue;
	...
	function NewRow() {
		...
		$row['ResetTime'] = $this->ResetTime->CurrentValue;
		$row['ResetType'] = $this->ResetType->CurrentValue;
		$row['CompleteTask'] = $this->CompleteTask->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// ResetTime
		$this->ResetTime->SetDbValueDef($rsnew, $this->ResetTime->CurrentValue, "", FALSE);

		// ResetType
		$this->ResetType->SetDbValueDef($rsnew, $this->ResetType->CurrentValue, "", FALSE);

		// CompleteTask
		$this->CompleteTask->SetDbValueDef($rsnew, $this->CompleteTask->CurrentValue, "", FALSE);
		...
		// Reward_Diamonds
		$this->Reward_Diamonds->SetDbValueDef($rsnew, $this->Reward_Diamonds->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($config_task_add)) $config_task_add = new cconfig_task_add();

// Page init
$config_task_add->Page_Init();

// Page main
$config_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_task_add->Page_Render();
?>
...
var CurrentForm = fconfig_taskadd = new ew_Form("fconfig_taskadd", "add");

// Validate form
fconfig_taskadd.Validate = function() {
...
fconfig_taskadd.Form_CustomValidate = 
...
fconfig_taskadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_task_add->ShowPageHeader(); ?>
<?php
$config_task_add->ShowMessage();
?>
<form name="fconfig_taskadd" id="fconfig_taskadd" class="<?php echo $config_task_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_task_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_task_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_task_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_task->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_task_u_id" for="x_u_id" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->u_id->CellAttributes() ?>>
...
<?php if ($config_task->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_task_acl_id" for="x_acl_id" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->acl_id->CellAttributes() ?>>
...
<?php if ($config_task->Title->Visible) { // Title ?>
	<div id="r_Title" class="form-group">
		<label id="elh_config_task_Title" for="x_Title" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Title->CellAttributes() ?>>
...
<?php if ($config_task->LV->Visible) { // LV ?>
	<div id="r_LV" class="form-group">
		<label id="elh_config_task_LV" for="x_LV" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->LV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->LV->CellAttributes() ?>>
...
<?php if ($config_task->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group">
		<label id="elh_config_task_Type" for="x_Type" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Type->CellAttributes() ?>>
...
<?php if ($config_task->ResetTime->Visible) { // ResetTime ?>
	<div id="r_ResetTime" class="form-group">
		<label id="elh_config_task_ResetTime" for="x_ResetTime" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->ResetTime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->ResetTime->CellAttributes() ?>>
...
<?php if ($config_task->ResetType->Visible) { // ResetType ?>
	<div id="r_ResetType" class="form-group">
		<label id="elh_config_task_ResetType" for="x_ResetType" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->ResetType->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->ResetType->CellAttributes() ?>>
...
<?php if ($config_task->CompleteTask->Visible) { // CompleteTask ?>
	<div id="r_CompleteTask" class="form-group">
		<label id="elh_config_task_CompleteTask" for="x_CompleteTask" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->CompleteTask->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->CompleteTask->CellAttributes() ?>>
...
<?php if ($config_task->Occupation->Visible) { // Occupation ?>
	<div id="r_Occupation" class="form-group">
		<label id="elh_config_task_Occupation" for="x_Occupation" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Occupation->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Occupation->CellAttributes() ?>>
...
<?php if ($config_task->Target->Visible) { // Target ?>
	<div id="r_Target" class="form-group">
		<label id="elh_config_task_Target" for="x_Target" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Target->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Target->CellAttributes() ?>>
...
<?php if ($config_task->Data->Visible) { // Data ?>
	<div id="r_Data" class="form-group">
		<label id="elh_config_task_Data" for="x_Data" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Data->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Data->CellAttributes() ?>>
...
<?php if ($config_task->Reward_Gold->Visible) { // Reward_Gold ?>
	<div id="r_Reward_Gold" class="form-group">
		<label id="elh_config_task_Reward_Gold" for="x_Reward_Gold" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Reward_Gold->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Reward_Gold->CellAttributes() ?>>
...
<?php if ($config_task->Reward_Diamonds->Visible) { // Reward_Diamonds ?>
	<div id="r_Reward_Diamonds" class="form-group">
		<label id="elh_config_task_Reward_Diamonds" for="x_Reward_Diamonds" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Reward_Diamonds->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Reward_Diamonds->CellAttributes() ?>>
...
<?php if ($config_task->Reward_EXP->Visible) { // Reward_EXP ?>
	<div id="r_Reward_EXP" class="form-group">
		<label id="elh_config_task_Reward_EXP" for="x_Reward_EXP" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Reward_EXP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Reward_EXP->CellAttributes() ?>>
...
<?php if ($config_task->Reward_Goods->Visible) { // Reward_Goods ?>
	<div id="r_Reward_Goods" class="form-group">
		<label id="elh_config_task_Reward_Goods" for="x_Reward_Goods" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Reward_Goods->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Reward_Goods->CellAttributes() ?>>
...
<?php if ($config_task->Info->Visible) { // Info ?>
	<div id="r_Info" class="form-group">
		<label id="elh_config_task_Info" for="x_Info" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->Info->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->Info->CellAttributes() ?>>
...
<?php if ($config_task->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_task_DATETIME" for="x_DATETIME" class="<?php echo $config_task_add->LeftColumnClass ?>"><?php echo $config_task->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_task_add->RightColumnClass ?>"><div<?php echo $config_task->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_task_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_task_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_task_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_taskadd.Init();
</script>
<?php
$config_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_task_add->Page_Terminate();
?>

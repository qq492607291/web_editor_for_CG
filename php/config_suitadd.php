...
$config_suit_add = NULL; // Initialize page object first

class cconfig_suit_add extends cconfig_suit {
	...
	// Page object name
	var $PageObjName = 'config_suit_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_suitview.php")
...
// Create page object
if (!isset($config_suit_add)) $config_suit_add = new cconfig_suit_add();

// Page init
$config_suit_add->Page_Init();

// Page main
$config_suit_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_suit_add->Page_Render();
?>
...
var CurrentForm = fconfig_suitadd = new ew_Form("fconfig_suitadd", "add");

// Validate form
fconfig_suitadd.Validate = function() {
...
fconfig_suitadd.Form_CustomValidate = 
...
fconfig_suitadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_suit_add->ShowPageHeader(); ?>
<?php
$config_suit_add->ShowMessage();
?>
<form name="fconfig_suitadd" id="fconfig_suitadd" class="<?php echo $config_suit_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_suit_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_suit_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_suit">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_suit_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_suit->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_suit_u_id" for="x_u_id" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->u_id->CellAttributes() ?>>
...
<?php if ($config_suit->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_suit_acl_id" for="x_acl_id" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->acl_id->CellAttributes() ?>>
...
<?php if ($config_suit->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_config_suit_Name" for="x_Name" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Name->CellAttributes() ?>>
...
<?php if ($config_suit->Add_HP->Visible) { // Add_HP ?>
	<div id="r_Add_HP" class="form-group">
		<label id="elh_config_suit_Add_HP" for="x_Add_HP" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_HP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_HP->CellAttributes() ?>>
...
<?php if ($config_suit->Add_MP->Visible) { // Add_MP ?>
	<div id="r_Add_MP" class="form-group">
		<label id="elh_config_suit_Add_MP" for="x_Add_MP" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_MP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_MP->CellAttributes() ?>>
...
<?php if ($config_suit->Add_Defense->Visible) { // Add_Defense ?>
	<div id="r_Add_Defense" class="form-group">
		<label id="elh_config_suit_Add_Defense" for="x_Add_Defense" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_Defense->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_Defense->CellAttributes() ?>>
...
<?php if ($config_suit->Add_Magic->Visible) { // Add_Magic ?>
	<div id="r_Add_Magic" class="form-group">
		<label id="elh_config_suit_Add_Magic" for="x_Add_Magic" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_Magic->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_Magic->CellAttributes() ?>>
...
<?php if ($config_suit->Add_AD->Visible) { // Add_AD ?>
	<div id="r_Add_AD" class="form-group">
		<label id="elh_config_suit_Add_AD" for="x_Add_AD" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_AD->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_AD->CellAttributes() ?>>
...
<?php if ($config_suit->Add_AP->Visible) { // Add_AP ?>
	<div id="r_Add_AP" class="form-group">
		<label id="elh_config_suit_Add_AP" for="x_Add_AP" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_AP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_AP->CellAttributes() ?>>
...
<?php if ($config_suit->Add_Hit->Visible) { // Add_Hit ?>
	<div id="r_Add_Hit" class="form-group">
		<label id="elh_config_suit_Add_Hit" for="x_Add_Hit" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_Hit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_Hit->CellAttributes() ?>>
...
<?php if ($config_suit->Add_Dodge->Visible) { // Add_Dodge ?>
	<div id="r_Add_Dodge" class="form-group">
		<label id="elh_config_suit_Add_Dodge" for="x_Add_Dodge" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_Dodge->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_Dodge->CellAttributes() ?>>
...
<?php if ($config_suit->Add_Crit->Visible) { // Add_Crit ?>
	<div id="r_Add_Crit" class="form-group">
		<label id="elh_config_suit_Add_Crit" for="x_Add_Crit" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_Crit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_Crit->CellAttributes() ?>>
...
<?php if ($config_suit->Add_AbsorbHP->Visible) { // Add_AbsorbHP ?>
	<div id="r_Add_AbsorbHP" class="form-group">
		<label id="elh_config_suit_Add_AbsorbHP" for="x_Add_AbsorbHP" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_AbsorbHP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_AbsorbHP->CellAttributes() ?>>
...
<?php if ($config_suit->Add_ADPTV->Visible) { // Add_ADPTV ?>
	<div id="r_Add_ADPTV" class="form-group">
		<label id="elh_config_suit_Add_ADPTV" for="x_Add_ADPTV" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_ADPTV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_ADPTV->CellAttributes() ?>>
...
<?php if ($config_suit->Add_ADPTR->Visible) { // Add_ADPTR ?>
	<div id="r_Add_ADPTR" class="form-group">
		<label id="elh_config_suit_Add_ADPTR" for="x_Add_ADPTR" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_ADPTR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_ADPTR->CellAttributes() ?>>
...
<?php if ($config_suit->Add_APPTR->Visible) { // Add_APPTR ?>
	<div id="r_Add_APPTR" class="form-group">
		<label id="elh_config_suit_Add_APPTR" for="x_Add_APPTR" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_APPTR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_APPTR->CellAttributes() ?>>
...
<?php if ($config_suit->Add_APPTV->Visible) { // Add_APPTV ?>
	<div id="r_Add_APPTV" class="form-group">
		<label id="elh_config_suit_Add_APPTV" for="x_Add_APPTV" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_APPTV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_APPTV->CellAttributes() ?>>
...
<?php if ($config_suit->Add_ImmuneDamage->Visible) { // Add_ImmuneDamage ?>
	<div id="r_Add_ImmuneDamage" class="form-group">
		<label id="elh_config_suit_Add_ImmuneDamage" for="x_Add_ImmuneDamage" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Add_ImmuneDamage->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Add_ImmuneDamage->CellAttributes() ?>>
...
<?php if ($config_suit->Special_Type->Visible) { // Special_Type ?>
	<div id="r_Special_Type" class="form-group">
		<label id="elh_config_suit_Special_Type" for="x_Special_Type" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Special_Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Special_Type->CellAttributes() ?>>
...
<?php if ($config_suit->Special_Value->Visible) { // Special_Value ?>
	<div id="r_Special_Value" class="form-group">
		<label id="elh_config_suit_Special_Value" for="x_Special_Value" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->Special_Value->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->Special_Value->CellAttributes() ?>>
...
<?php if ($config_suit->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_suit_DATETIME" for="x_DATETIME" class="<?php echo $config_suit_add->LeftColumnClass ?>"><?php echo $config_suit->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_suit_add->RightColumnClass ?>"><div<?php echo $config_suit->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_suit_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_suit_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_suit_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_suitadd.Init();
</script>
<?php
$config_suit_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_suit_add->Page_Terminate();
?>

...
$dynamicattributes_register = NULL;

//
// Table class for dynamicattributes_register
//
class cdynamicattributes_register extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $User;
	...
	function __construct() {
		...
		$this->TableVar = 'dynamicattributes_register';
		$this->TableName = 'dynamicattributes_register';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`dynamicattributes_register`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// User
		$this->User = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_User', 'User', '`User`', '`User`', 201, -1, FALSE, '`User`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->User->Sortable = TRUE; // Allow sort
		$this->fields['User'] = &$this->User;

		// AttName
		$this->AttName = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_AttName', 'AttName', '`AttName`', '`AttName`', 201, -1, FALSE, '`AttName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AttName->Sortable = TRUE; // Allow sort
		$this->fields['AttName'] = &$this->AttName;

		// AttValue
		$this->AttValue = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_AttValue', 'AttValue', '`AttValue`', '`AttValue`', 201, -1, FALSE, '`AttValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AttValue->Sortable = TRUE; // Allow sort
		$this->fields['AttValue'] = &$this->AttValue;

		// AttInvalidTime
		$this->AttInvalidTime = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_AttInvalidTime', 'AttInvalidTime', '`AttInvalidTime`', '`AttInvalidTime`', 201, -1, FALSE, '`AttInvalidTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AttInvalidTime->Sortable = TRUE; // Allow sort
		$this->fields['AttInvalidTime'] = &$this->AttInvalidTime;

		// DATETIME
		$this->DATETIME = new cField('dynamicattributes_register', 'dynamicattributes_register', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`dynamicattributes_register`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "dynamicattributes_registerlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "dynamicattributes_registeredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "dynamicattributes_registeradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("dynamicattributes_registerview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("dynamicattributes_registerview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "dynamicattributes_registeradd.php?" . $this->UrlParm($parm);
		else
			$url = "dynamicattributes_registeradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("dynamicattributes_registeredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("dynamicattributes_registeradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("dynamicattributes_registerdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->AttName->setDbValue($rs->fields('AttName'));
		$this->AttValue->setDbValue($rs->fields('AttValue'));
		$this->AttInvalidTime->setDbValue($rs->fields('AttInvalidTime'));
	...
	function RenderEditRow() {
		...
		$this->AttName->EditValue = $this->AttName->CurrentValue;
		...
		$this->AttValue->EditValue = $this->AttValue->CurrentValue;
		...
		$this->AttInvalidTime->EditValue = $this->AttInvalidTime->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->AttName->Exportable) $Doc->ExportCaption($this->AttName);
					if ($this->AttValue->Exportable) $Doc->ExportCaption($this->AttValue);
					if ($this->AttInvalidTime->Exportable) $Doc->ExportCaption($this->AttInvalidTime);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->AttName->Exportable) $Doc->ExportField($this->AttName);
						if ($this->AttValue->Exportable) $Doc->ExportField($this->AttValue);
						if ($this->AttInvalidTime->Exportable) $Doc->ExportField($this->AttInvalidTime);

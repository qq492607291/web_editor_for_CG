...
$ext_goodsextattr_edit = NULL; // Initialize page object first

class cext_goodsextattr_edit extends cext_goodsextattr {
	...
	// Page object name
	var $PageObjName = 'ext_goodsextattr_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// PriceNum
			$this->PriceNum->SetDbValueDef($rsnew, $this->PriceNum->CurrentValue, "", $this->PriceNum->ReadOnly);

			// PriceType
			$this->PriceType->SetDbValueDef($rsnew, $this->PriceType->CurrentValue, "", $this->PriceType->ReadOnly);

			// UD_qualityNum
			$this->UD_qualityNum->SetDbValueDef($rsnew, $this->UD_qualityNum->CurrentValue, "", $this->UD_qualityNum->ReadOnly);

			// UD_cat
			$this->UD_cat->SetDbValueDef($rsnew, $this->UD_cat->CurrentValue, "", $this->UD_cat->ReadOnly);

			// UD_qualityType
			$this->UD_qualityType->SetDbValueDef($rsnew, $this->UD_qualityType->CurrentValue, "", $this->UD_qualityType->ReadOnly);

			// UD_kv4
			$this->UD_kv4->SetDbValueDef($rsnew, $this->UD_kv4->CurrentValue, "", $this->UD_kv4->ReadOnly);

			// UD_kv5
			$this->UD_kv5->SetDbValueDef($rsnew, $this->UD_kv5->CurrentValue, "", $this->UD_kv5->ReadOnly);

			// UD_kv6
			$this->UD_kv6->SetDbValueDef($rsnew, $this->UD_kv6->CurrentValue, "", $this->UD_kv6->ReadOnly);

			// UD_kv7
			$this->UD_kv7->SetDbValueDef($rsnew, $this->UD_kv7->CurrentValue, "", $this->UD_kv7->ReadOnly);

			// UD_kv8
			$this->UD_kv8->SetDbValueDef($rsnew, $this->UD_kv8->CurrentValue, "", $this->UD_kv8->ReadOnly);

			// UD_kv9
			$this->UD_kv9->SetDbValueDef($rsnew, $this->UD_kv9->CurrentValue, "", $this->UD_kv9->ReadOnly);

			// UD_kv10
			$this->UD_kv10->SetDbValueDef($rsnew, $this->UD_kv10->CurrentValue, "", $this->UD_kv10->ReadOnly);
...
// Create page object
if (!isset($ext_goodsextattr_edit)) $ext_goodsextattr_edit = new cext_goodsextattr_edit();

// Page init
$ext_goodsextattr_edit->Page_Init();

// Page main
$ext_goodsextattr_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_goodsextattr_edit->Page_Render();
?>
...
var CurrentForm = fext_goodsextattredit = new ew_Form("fext_goodsextattredit", "edit");

// Validate form
fext_goodsextattredit.Validate = function() {
...
fext_goodsextattredit.Form_CustomValidate = 
...
fext_goodsextattredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_goodsextattr_edit->ShowPageHeader(); ?>
<?php
$ext_goodsextattr_edit->ShowMessage();
?>
<form name="fext_goodsextattredit" id="fext_goodsextattredit" class="<?php echo $ext_goodsextattr_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_goodsextattr_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_goodsextattr_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_goodsextattr">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($ext_goodsextattr_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($ext_goodsextattr->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_ext_goodsextattr_unid" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->unid->FldCaption() ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->unid->CellAttributes() ?>>
<span id="el_ext_goodsextattr_unid">
<span<?php echo $ext_goodsextattr->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $ext_goodsextattr->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ext_goodsextattr" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($ext_goodsextattr->unid->CurrentValue) ?>">
<?php echo $ext_goodsextattr->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ext_goodsextattr->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_goodsextattr_u_id" for="x_u_id" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->u_id->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_goodsextattr_acl_id" for="x_acl_id" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->acl_id->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_ext_goodsextattr_Name" for="x_Name" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->Name->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->PriceNum->Visible) { // PriceNum ?>
	<div id="r_PriceNum" class="form-group">
		<label id="elh_ext_goodsextattr_PriceNum" for="x_PriceNum" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->PriceNum->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->PriceNum->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->PriceType->Visible) { // PriceType ?>
	<div id="r_PriceType" class="form-group">
		<label id="elh_ext_goodsextattr_PriceType" for="x_PriceType" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->PriceType->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->PriceType->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_qualityNum->Visible) { // UD_qualityNum ?>
	<div id="r_UD_qualityNum" class="form-group">
		<label id="elh_ext_goodsextattr_UD_qualityNum" for="x_UD_qualityNum" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_qualityNum->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_qualityNum->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_cat->Visible) { // UD_cat ?>
	<div id="r_UD_cat" class="form-group">
		<label id="elh_ext_goodsextattr_UD_cat" for="x_UD_cat" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_cat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_cat->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_qualityType->Visible) { // UD_qualityType ?>
	<div id="r_UD_qualityType" class="form-group">
		<label id="elh_ext_goodsextattr_UD_qualityType" for="x_UD_qualityType" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_qualityType->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_qualityType->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv4->Visible) { // UD_kv4 ?>
	<div id="r_UD_kv4" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv4" for="x_UD_kv4" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv4->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv4->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv5->Visible) { // UD_kv5 ?>
	<div id="r_UD_kv5" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv5" for="x_UD_kv5" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv5->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv5->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv6->Visible) { // UD_kv6 ?>
	<div id="r_UD_kv6" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv6" for="x_UD_kv6" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv6->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv6->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv7->Visible) { // UD_kv7 ?>
	<div id="r_UD_kv7" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv7" for="x_UD_kv7" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv7->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv7->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv8->Visible) { // UD_kv8 ?>
	<div id="r_UD_kv8" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv8" for="x_UD_kv8" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv8->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv8->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv9->Visible) { // UD_kv9 ?>
	<div id="r_UD_kv9" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv9" for="x_UD_kv9" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv9->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv9->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->UD_kv10->Visible) { // UD_kv10 ?>
	<div id="r_UD_kv10" class="form-group">
		<label id="elh_ext_goodsextattr_UD_kv10" for="x_UD_kv10" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->UD_kv10->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->UD_kv10->CellAttributes() ?>>
...
<?php if ($ext_goodsextattr->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_goodsextattr_DATETIME" for="x_DATETIME" class="<?php echo $ext_goodsextattr_edit->LeftColumnClass ?>"><?php echo $ext_goodsextattr->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_goodsextattr_edit->RightColumnClass ?>"><div<?php echo $ext_goodsextattr->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_goodsextattr_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_goodsextattr_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_goodsextattr_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_goodsextattredit.Init();
</script>
<?php
$ext_goodsextattr_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_goodsextattr_edit->Page_Terminate();
?>

...
$ksdb_user_edit = NULL; // Initialize page object first

class cksdb_user_edit extends cksdb_user {
	...
	// Page object name
	var $PageObjName = 'ksdb_user_edit';
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->Page_Terminate("ksdb_userlist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "ksdb_userlist.php")
...
// Create page object
if (!isset($ksdb_user_edit)) $ksdb_user_edit = new cksdb_user_edit();

// Page init
$ksdb_user_edit->Page_Init();

// Page main
$ksdb_user_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ksdb_user_edit->Page_Render();
?>
...
var CurrentForm = fksdb_useredit = new ew_Form("fksdb_useredit", "edit");

// Validate form
fksdb_useredit.Validate = function() {
...
fksdb_useredit.Form_CustomValidate = 
...
fksdb_useredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ksdb_user_edit->ShowPageHeader(); ?>
<?php
$ksdb_user_edit->ShowMessage();
?>
<form name="fksdb_useredit" id="fksdb_useredit" class="<?php echo $ksdb_user_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ksdb_user_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ksdb_user_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ksdb_user">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($ksdb_user_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
</div><!-- /page* -->
<input type="hidden" data-table="ksdb_user" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($ksdb_user->id->CurrentValue) ?>">
<?php if (!$ksdb_user_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ksdb_user_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ksdb_user_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->

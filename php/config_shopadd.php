...
$config_shop_add = NULL; // Initialize page object first

class cconfig_shop_add extends cconfig_shop {
	...
	// Page object name
	var $PageObjName = 'config_shop_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_shopview.php")
	...
	function LoadDefaultValues() {
		...
		$this->LimitNumber->CurrentValue = NULL;
		$this->LimitNumber->OldValue = $this->LimitNumber->CurrentValue;
		$this->LimitType->CurrentValue = NULL;
		$this->LimitType->OldValue = $this->LimitType->CurrentValue;
	...
	function NewRow() {
		...
		$row['LimitNumber'] = $this->LimitNumber->CurrentValue;
		$row['LimitType'] = $this->LimitType->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// LimitNumber
		$this->LimitNumber->SetDbValueDef($rsnew, $this->LimitNumber->CurrentValue, "", FALSE);

		// LimitType
		$this->LimitType->SetDbValueDef($rsnew, $this->LimitType->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($config_shop_add)) $config_shop_add = new cconfig_shop_add();

// Page init
$config_shop_add->Page_Init();

// Page main
$config_shop_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_shop_add->Page_Render();
?>
...
var CurrentForm = fconfig_shopadd = new ew_Form("fconfig_shopadd", "add");

// Validate form
fconfig_shopadd.Validate = function() {
...
fconfig_shopadd.Form_CustomValidate = 
...
fconfig_shopadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_shop_add->ShowPageHeader(); ?>
<?php
$config_shop_add->ShowMessage();
?>
<form name="fconfig_shopadd" id="fconfig_shopadd" class="<?php echo $config_shop_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_shop_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_shop_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_shop">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_shop_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_shop->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_shop_u_id" for="x_u_id" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->u_id->CellAttributes() ?>>
...
<?php if ($config_shop->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_shop_acl_id" for="x_acl_id" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->acl_id->CellAttributes() ?>>
...
<?php if ($config_shop->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_config_shop_Name" for="x_Name" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->Name->CellAttributes() ?>>
...
<?php if ($config_shop->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group">
		<label id="elh_config_shop_Currency" for="x_Currency" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->Currency->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->Currency->CellAttributes() ?>>
...
<?php if ($config_shop->Price->Visible) { // Price ?>
	<div id="r_Price" class="form-group">
		<label id="elh_config_shop_Price" for="x_Price" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->Price->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->Price->CellAttributes() ?>>
...
<?php if ($config_shop->LimitNumber->Visible) { // LimitNumber ?>
	<div id="r_LimitNumber" class="form-group">
		<label id="elh_config_shop_LimitNumber" for="x_LimitNumber" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->LimitNumber->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->LimitNumber->CellAttributes() ?>>
...
<?php if ($config_shop->LimitType->Visible) { // LimitType ?>
	<div id="r_LimitType" class="form-group">
		<label id="elh_config_shop_LimitType" for="x_LimitType" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->LimitType->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->LimitType->CellAttributes() ?>>
...
<?php if ($config_shop->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_shop_DATETIME" for="x_DATETIME" class="<?php echo $config_shop_add->LeftColumnClass ?>"><?php echo $config_shop->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_shop_add->RightColumnClass ?>"><div<?php echo $config_shop->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_shop_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_shop_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_shop_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_shopadd.Init();
</script>
<?php
$config_shop_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_shop_add->Page_Terminate();
?>

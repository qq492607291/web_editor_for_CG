...
$ext_customvariable_info_edit = NULL; // Initialize page object first

class cext_customvariable_info_edit extends cext_customvariable_info {
	...
	// Page object name
	var $PageObjName = 'ext_customvariable_info_edit';
...
// Create page object
if (!isset($ext_customvariable_info_edit)) $ext_customvariable_info_edit = new cext_customvariable_info_edit();

// Page init
$ext_customvariable_info_edit->Page_Init();

// Page main
$ext_customvariable_info_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_customvariable_info_edit->Page_Render();
?>
...
var CurrentForm = fext_customvariable_infoedit = new ew_Form("fext_customvariable_infoedit", "edit");

// Validate form
fext_customvariable_infoedit.Validate = function() {
...
fext_customvariable_infoedit.Form_CustomValidate = 
...
fext_customvariable_infoedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_customvariable_info_edit->ShowPageHeader(); ?>
<?php
$ext_customvariable_info_edit->ShowMessage();
?>
<form name="fext_customvariable_infoedit" id="fext_customvariable_infoedit" class="<?php echo $ext_customvariable_info_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_customvariable_info_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_customvariable_info_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_customvariable_info">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($ext_customvariable_info_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($ext_customvariable_info->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_ext_customvariable_info_unid" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->unid->FldCaption() ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->unid->CellAttributes() ?>>
<span id="el_ext_customvariable_info_unid">
<span<?php echo $ext_customvariable_info->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $ext_customvariable_info->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ext_customvariable_info" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($ext_customvariable_info->unid->CurrentValue) ?>">
<?php echo $ext_customvariable_info->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ext_customvariable_info->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_customvariable_info_u_id" for="x_u_id" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->u_id->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_customvariable_info_acl_id" for="x_acl_id" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->acl_id->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_ext_customvariable_info_Name" for="x_Name" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->Name->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group">
		<label id="elh_ext_customvariable_info_Type" for="x_Type" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->Type->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->Function->Visible) { // Function ?>
	<div id="r_Function" class="form-group">
		<label id="elh_ext_customvariable_info_Function" for="x_Function" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->Function->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->Function->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->Dialog->Visible) { // Dialog ?>
	<div id="r_Dialog" class="form-group">
		<label id="elh_ext_customvariable_info_Dialog" for="x_Dialog" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->Dialog->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->Dialog->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->Introduce->Visible) { // Introduce ?>
	<div id="r_Introduce" class="form-group">
		<label id="elh_ext_customvariable_info_Introduce" for="x_Introduce" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->Introduce->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->Introduce->CellAttributes() ?>>
...
<?php if ($ext_customvariable_info->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_customvariable_info_DATETIME" for="x_DATETIME" class="<?php echo $ext_customvariable_info_edit->LeftColumnClass ?>"><?php echo $ext_customvariable_info->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_customvariable_info_edit->RightColumnClass ?>"><div<?php echo $ext_customvariable_info->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_customvariable_info_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_customvariable_info_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_customvariable_info_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_customvariable_infoedit.Init();
</script>
<?php
$ext_customvariable_info_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_customvariable_info_edit->Page_Terminate();
?>

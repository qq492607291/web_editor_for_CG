...
$config_occupation_edit = NULL; // Initialize page object first

class cconfig_occupation_edit extends cconfig_occupation {
	...
	// Page object name
	var $PageObjName = 'config_occupation_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Basics
			$this->Basics->SetDbValueDef($rsnew, $this->Basics->CurrentValue, "", $this->Basics->ReadOnly);

			// HP
			$this->HP->SetDbValueDef($rsnew, $this->HP->CurrentValue, "", $this->HP->ReadOnly);

			// MP
			$this->MP->SetDbValueDef($rsnew, $this->MP->CurrentValue, "", $this->MP->ReadOnly);

			// AD
			$this->AD->SetDbValueDef($rsnew, $this->AD->CurrentValue, "", $this->AD->ReadOnly);

			// AP
			$this->AP->SetDbValueDef($rsnew, $this->AP->CurrentValue, "", $this->AP->ReadOnly);

			// Defense
			$this->Defense->SetDbValueDef($rsnew, $this->Defense->CurrentValue, "", $this->Defense->ReadOnly);
			...
			// Crit
			$this->Crit->SetDbValueDef($rsnew, $this->Crit->CurrentValue, "", $this->Crit->ReadOnly);

			// AbsorbHP
			$this->AbsorbHP->SetDbValueDef($rsnew, $this->AbsorbHP->CurrentValue, "", $this->AbsorbHP->ReadOnly);

			// ADPTV
			$this->ADPTV->SetDbValueDef($rsnew, $this->ADPTV->CurrentValue, "", $this->ADPTV->ReadOnly);

			// ADPTR
			$this->ADPTR->SetDbValueDef($rsnew, $this->ADPTR->CurrentValue, "", $this->ADPTR->ReadOnly);

			// APPTR
			$this->APPTR->SetDbValueDef($rsnew, $this->APPTR->CurrentValue, "", $this->APPTR->ReadOnly);

			// APPTV
			$this->APPTV->SetDbValueDef($rsnew, $this->APPTV->CurrentValue, "", $this->APPTV->ReadOnly);

			// ImmuneDamage
			$this->ImmuneDamage->SetDbValueDef($rsnew, $this->ImmuneDamage->CurrentValue, "", $this->ImmuneDamage->ReadOnly);

			// Intro
			$this->Intro->SetDbValueDef($rsnew, $this->Intro->CurrentValue, "", $this->Intro->ReadOnly);

			// ExclusiveSkills
			$this->ExclusiveSkills->SetDbValueDef($rsnew, $this->ExclusiveSkills->CurrentValue, "", $this->ExclusiveSkills->ReadOnly);

			// TransferDemand
			$this->TransferDemand->SetDbValueDef($rsnew, $this->TransferDemand->CurrentValue, "", $this->TransferDemand->ReadOnly);

			// TransferLevel
			$this->TransferLevel->SetDbValueDef($rsnew, $this->TransferLevel->CurrentValue, "", $this->TransferLevel->ReadOnly);

			// FormerOccupation
			$this->FormerOccupation->SetDbValueDef($rsnew, $this->FormerOccupation->CurrentValue, "", $this->FormerOccupation->ReadOnly);

			// Belong
			$this->Belong->SetDbValueDef($rsnew, $this->Belong->CurrentValue, "", $this->Belong->ReadOnly);
...
// Create page object
if (!isset($config_occupation_edit)) $config_occupation_edit = new cconfig_occupation_edit();

// Page init
$config_occupation_edit->Page_Init();

// Page main
$config_occupation_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_occupation_edit->Page_Render();
?>
...
var CurrentForm = fconfig_occupationedit = new ew_Form("fconfig_occupationedit", "edit");

// Validate form
fconfig_occupationedit.Validate = function() {
...
fconfig_occupationedit.Form_CustomValidate = 
...
fconfig_occupationedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_occupation_edit->ShowPageHeader(); ?>
<?php
$config_occupation_edit->ShowMessage();
?>
<form name="fconfig_occupationedit" id="fconfig_occupationedit" class="<?php echo $config_occupation_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_occupation_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_occupation_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_occupation">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($config_occupation_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($config_occupation->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_occupation_u_id" for="x_u_id" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->u_id->CellAttributes() ?>>
...
<?php if ($config_occupation->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_occupation_acl_id" for="x_acl_id" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->acl_id->CellAttributes() ?>>
...
<?php if ($config_occupation->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_config_occupation_Name" for="x_Name" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Name->CellAttributes() ?>>
...
<?php if ($config_occupation->Basics->Visible) { // Basics ?>
	<div id="r_Basics" class="form-group">
		<label id="elh_config_occupation_Basics" for="x_Basics" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Basics->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Basics->CellAttributes() ?>>
...
<?php if ($config_occupation->HP->Visible) { // HP ?>
	<div id="r_HP" class="form-group">
		<label id="elh_config_occupation_HP" for="x_HP" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->HP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->HP->CellAttributes() ?>>
...
<?php if ($config_occupation->MP->Visible) { // MP ?>
	<div id="r_MP" class="form-group">
		<label id="elh_config_occupation_MP" for="x_MP" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->MP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->MP->CellAttributes() ?>>
...
<?php if ($config_occupation->AD->Visible) { // AD ?>
	<div id="r_AD" class="form-group">
		<label id="elh_config_occupation_AD" for="x_AD" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->AD->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->AD->CellAttributes() ?>>
...
<?php if ($config_occupation->AP->Visible) { // AP ?>
	<div id="r_AP" class="form-group">
		<label id="elh_config_occupation_AP" for="x_AP" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->AP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->AP->CellAttributes() ?>>
...
<?php if ($config_occupation->Defense->Visible) { // Defense ?>
	<div id="r_Defense" class="form-group">
		<label id="elh_config_occupation_Defense" for="x_Defense" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Defense->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Defense->CellAttributes() ?>>
...
<?php if ($config_occupation->Hit->Visible) { // Hit ?>
	<div id="r_Hit" class="form-group">
		<label id="elh_config_occupation_Hit" for="x_Hit" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Hit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Hit->CellAttributes() ?>>
...
<?php if ($config_occupation->Dodge->Visible) { // Dodge ?>
	<div id="r_Dodge" class="form-group">
		<label id="elh_config_occupation_Dodge" for="x_Dodge" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Dodge->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Dodge->CellAttributes() ?>>
...
<?php if ($config_occupation->Crit->Visible) { // Crit ?>
	<div id="r_Crit" class="form-group">
		<label id="elh_config_occupation_Crit" for="x_Crit" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Crit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Crit->CellAttributes() ?>>
...
<?php if ($config_occupation->AbsorbHP->Visible) { // AbsorbHP ?>
	<div id="r_AbsorbHP" class="form-group">
		<label id="elh_config_occupation_AbsorbHP" for="x_AbsorbHP" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->AbsorbHP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->AbsorbHP->CellAttributes() ?>>
...
<?php if ($config_occupation->ADPTV->Visible) { // ADPTV ?>
	<div id="r_ADPTV" class="form-group">
		<label id="elh_config_occupation_ADPTV" for="x_ADPTV" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->ADPTV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->ADPTV->CellAttributes() ?>>
...
<?php if ($config_occupation->ADPTR->Visible) { // ADPTR ?>
	<div id="r_ADPTR" class="form-group">
		<label id="elh_config_occupation_ADPTR" for="x_ADPTR" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->ADPTR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->ADPTR->CellAttributes() ?>>
...
<?php if ($config_occupation->APPTR->Visible) { // APPTR ?>
	<div id="r_APPTR" class="form-group">
		<label id="elh_config_occupation_APPTR" for="x_APPTR" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->APPTR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->APPTR->CellAttributes() ?>>
...
<?php if ($config_occupation->APPTV->Visible) { // APPTV ?>
	<div id="r_APPTV" class="form-group">
		<label id="elh_config_occupation_APPTV" for="x_APPTV" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->APPTV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->APPTV->CellAttributes() ?>>
...
<?php if ($config_occupation->ImmuneDamage->Visible) { // ImmuneDamage ?>
	<div id="r_ImmuneDamage" class="form-group">
		<label id="elh_config_occupation_ImmuneDamage" for="x_ImmuneDamage" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->ImmuneDamage->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->ImmuneDamage->CellAttributes() ?>>
...
<?php if ($config_occupation->Intro->Visible) { // Intro ?>
	<div id="r_Intro" class="form-group">
		<label id="elh_config_occupation_Intro" for="x_Intro" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Intro->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Intro->CellAttributes() ?>>
...
<?php if ($config_occupation->ExclusiveSkills->Visible) { // ExclusiveSkills ?>
	<div id="r_ExclusiveSkills" class="form-group">
		<label id="elh_config_occupation_ExclusiveSkills" for="x_ExclusiveSkills" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->ExclusiveSkills->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->ExclusiveSkills->CellAttributes() ?>>
...
<?php if ($config_occupation->TransferDemand->Visible) { // TransferDemand ?>
	<div id="r_TransferDemand" class="form-group">
		<label id="elh_config_occupation_TransferDemand" for="x_TransferDemand" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->TransferDemand->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->TransferDemand->CellAttributes() ?>>
...
<?php if ($config_occupation->TransferLevel->Visible) { // TransferLevel ?>
	<div id="r_TransferLevel" class="form-group">
		<label id="elh_config_occupation_TransferLevel" for="x_TransferLevel" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->TransferLevel->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->TransferLevel->CellAttributes() ?>>
...
<?php if ($config_occupation->FormerOccupation->Visible) { // FormerOccupation ?>
	<div id="r_FormerOccupation" class="form-group">
		<label id="elh_config_occupation_FormerOccupation" for="x_FormerOccupation" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->FormerOccupation->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->FormerOccupation->CellAttributes() ?>>
...
<?php if ($config_occupation->Belong->Visible) { // Belong ?>
	<div id="r_Belong" class="form-group">
		<label id="elh_config_occupation_Belong" for="x_Belong" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->Belong->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->Belong->CellAttributes() ?>>
...
<?php if ($config_occupation->AttackEffect->Visible) { // AttackEffect ?>
	<div id="r_AttackEffect" class="form-group">
		<label id="elh_config_occupation_AttackEffect" for="x_AttackEffect" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->AttackEffect->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->AttackEffect->CellAttributes() ?>>
...
<?php if ($config_occupation->AttackTips->Visible) { // AttackTips ?>
	<div id="r_AttackTips" class="form-group">
		<label id="elh_config_occupation_AttackTips" for="x_AttackTips" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->AttackTips->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->AttackTips->CellAttributes() ?>>
...
<?php if ($config_occupation->MagicResistance->Visible) { // MagicResistance ?>
	<div id="r_MagicResistance" class="form-group">
		<label id="elh_config_occupation_MagicResistance" for="x_MagicResistance" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->MagicResistance->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->MagicResistance->CellAttributes() ?>>
...
<?php if ($config_occupation->IgnoreShield->Visible) { // IgnoreShield ?>
	<div id="r_IgnoreShield" class="form-group">
		<label id="elh_config_occupation_IgnoreShield" for="x_IgnoreShield" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->IgnoreShield->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->IgnoreShield->CellAttributes() ?>>
...
<?php if ($config_occupation->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_occupation_DATETIME" for="x_DATETIME" class="<?php echo $config_occupation_edit->LeftColumnClass ?>"><?php echo $config_occupation->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_occupation_edit->RightColumnClass ?>"><div<?php echo $config_occupation->DATETIME->CellAttributes() ?>>
...
<input type="hidden" data-table="config_occupation" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($config_occupation->unid->CurrentValue) ?>">
<?php if (!$config_occupation_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_occupation_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_occupation_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_occupationedit.Init();
</script>
<?php
$config_occupation_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_occupation_edit->Page_Terminate();
?>

...
$task_register_edit = NULL; // Initialize page object first

class ctask_register_edit extends ctask_register {
	...
	// Page object name
	var $PageObjName = 'task_register_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Complete
			$this->Complete->SetDbValueDef($rsnew, $this->Complete->CurrentValue, "", $this->Complete->ReadOnly);
...
// Create page object
if (!isset($task_register_edit)) $task_register_edit = new ctask_register_edit();

// Page init
$task_register_edit->Page_Init();

// Page main
$task_register_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$task_register_edit->Page_Render();
?>
...
var CurrentForm = ftask_registeredit = new ew_Form("ftask_registeredit", "edit");

// Validate form
ftask_registeredit.Validate = function() {
...
ftask_registeredit.Form_CustomValidate = 
...
ftask_registeredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $task_register_edit->ShowPageHeader(); ?>
<?php
$task_register_edit->ShowMessage();
?>
<form name="ftask_registeredit" id="ftask_registeredit" class="<?php echo $task_register_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($task_register_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $task_register_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="task_register">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($task_register_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($task_register->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_task_register_unid" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->unid->FldCaption() ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->unid->CellAttributes() ?>>
<span id="el_task_register_unid">
<span<?php echo $task_register->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $task_register->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="task_register" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($task_register->unid->CurrentValue) ?>">
<?php echo $task_register->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($task_register->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_task_register_u_id" for="x_u_id" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->u_id->CellAttributes() ?>>
...
<?php if ($task_register->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_task_register_acl_id" for="x_acl_id" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->acl_id->CellAttributes() ?>>
...
<?php if ($task_register->User->Visible) { // User ?>
	<div id="r_User" class="form-group">
		<label id="elh_task_register_User" for="x_User" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->User->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->User->CellAttributes() ?>>
...
<?php if ($task_register->TaskName->Visible) { // TaskName ?>
	<div id="r_TaskName" class="form-group">
		<label id="elh_task_register_TaskName" for="x_TaskName" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->TaskName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->TaskName->CellAttributes() ?>>
...
<?php if ($task_register->Date->Visible) { // Date ?>
	<div id="r_Date" class="form-group">
		<label id="elh_task_register_Date" for="x_Date" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->Date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->Date->CellAttributes() ?>>
...
<?php if ($task_register->Target->Visible) { // Target ?>
	<div id="r_Target" class="form-group">
		<label id="elh_task_register_Target" for="x_Target" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->Target->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->Target->CellAttributes() ?>>
...
<?php if ($task_register->Data->Visible) { // Data ?>
	<div id="r_Data" class="form-group">
		<label id="elh_task_register_Data" for="x_Data" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->Data->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->Data->CellAttributes() ?>>
...
<?php if ($task_register->Complete->Visible) { // Complete ?>
	<div id="r_Complete" class="form-group">
		<label id="elh_task_register_Complete" for="x_Complete" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->Complete->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->Complete->CellAttributes() ?>>
...
<?php if ($task_register->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_task_register_DATETIME" for="x_DATETIME" class="<?php echo $task_register_edit->LeftColumnClass ?>"><?php echo $task_register->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $task_register_edit->RightColumnClass ?>"><div<?php echo $task_register->DATETIME->CellAttributes() ?>>
...
<?php if (!$task_register_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $task_register_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $task_register_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ftask_registeredit.Init();
</script>
<?php
$task_register_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$task_register_edit->Page_Terminate();
?>

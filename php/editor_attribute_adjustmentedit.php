...
$editor_attribute_adjustment_edit = NULL; // Initialize page object first

class ceditor_attribute_adjustment_edit extends ceditor_attribute_adjustment {
	...
	// Page object name
	var $PageObjName = 'editor_attribute_adjustment_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// aName
			$this->aName->SetDbValueDef($rsnew, $this->aName->CurrentValue, "", $this->aName->ReadOnly);
...
// Create page object
if (!isset($editor_attribute_adjustment_edit)) $editor_attribute_adjustment_edit = new ceditor_attribute_adjustment_edit();

// Page init
$editor_attribute_adjustment_edit->Page_Init();

// Page main
$editor_attribute_adjustment_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$editor_attribute_adjustment_edit->Page_Render();
?>
...
var CurrentForm = feditor_attribute_adjustmentedit = new ew_Form("feditor_attribute_adjustmentedit", "edit");

// Validate form
feditor_attribute_adjustmentedit.Validate = function() {
...
feditor_attribute_adjustmentedit.Form_CustomValidate = 
...
feditor_attribute_adjustmentedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $editor_attribute_adjustment_edit->ShowPageHeader(); ?>
<?php
$editor_attribute_adjustment_edit->ShowMessage();
?>
<form name="feditor_attribute_adjustmentedit" id="feditor_attribute_adjustmentedit" class="<?php echo $editor_attribute_adjustment_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($editor_attribute_adjustment_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $editor_attribute_adjustment_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="editor_attribute_adjustment">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($editor_attribute_adjustment_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($editor_attribute_adjustment->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_editor_attribute_adjustment_unid" class="<?php echo $editor_attribute_adjustment_edit->LeftColumnClass ?>"><?php echo $editor_attribute_adjustment->unid->FldCaption() ?></label>
		<div class="<?php echo $editor_attribute_adjustment_edit->RightColumnClass ?>"><div<?php echo $editor_attribute_adjustment->unid->CellAttributes() ?>>
<span id="el_editor_attribute_adjustment_unid">
<span<?php echo $editor_attribute_adjustment->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $editor_attribute_adjustment->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="editor_attribute_adjustment" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($editor_attribute_adjustment->unid->CurrentValue) ?>">
<?php echo $editor_attribute_adjustment->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($editor_attribute_adjustment->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_editor_attribute_adjustment_u_id" for="x_u_id" class="<?php echo $editor_attribute_adjustment_edit->LeftColumnClass ?>"><?php echo $editor_attribute_adjustment->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $editor_attribute_adjustment_edit->RightColumnClass ?>"><div<?php echo $editor_attribute_adjustment->u_id->CellAttributes() ?>>
...
<?php if ($editor_attribute_adjustment->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_editor_attribute_adjustment_acl_id" for="x_acl_id" class="<?php echo $editor_attribute_adjustment_edit->LeftColumnClass ?>"><?php echo $editor_attribute_adjustment->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $editor_attribute_adjustment_edit->RightColumnClass ?>"><div<?php echo $editor_attribute_adjustment->acl_id->CellAttributes() ?>>
...
<?php if ($editor_attribute_adjustment->uId->Visible) { // uId ?>
	<div id="r_uId" class="form-group">
		<label id="elh_editor_attribute_adjustment_uId" for="x_uId" class="<?php echo $editor_attribute_adjustment_edit->LeftColumnClass ?>"><?php echo $editor_attribute_adjustment->uId->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $editor_attribute_adjustment_edit->RightColumnClass ?>"><div<?php echo $editor_attribute_adjustment->uId->CellAttributes() ?>>
...
<?php if ($editor_attribute_adjustment->aName->Visible) { // aName ?>
	<div id="r_aName" class="form-group">
		<label id="elh_editor_attribute_adjustment_aName" for="x_aName" class="<?php echo $editor_attribute_adjustment_edit->LeftColumnClass ?>"><?php echo $editor_attribute_adjustment->aName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $editor_attribute_adjustment_edit->RightColumnClass ?>"><div<?php echo $editor_attribute_adjustment->aName->CellAttributes() ?>>
...
<?php if ($editor_attribute_adjustment->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_editor_attribute_adjustment_DATETIME" for="x_DATETIME" class="<?php echo $editor_attribute_adjustment_edit->LeftColumnClass ?>"><?php echo $editor_attribute_adjustment->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $editor_attribute_adjustment_edit->RightColumnClass ?>"><div<?php echo $editor_attribute_adjustment->DATETIME->CellAttributes() ?>>
...
<?php if (!$editor_attribute_adjustment_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $editor_attribute_adjustment_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $editor_attribute_adjustment_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
feditor_attribute_adjustmentedit.Init();
</script>
<?php
$editor_attribute_adjustment_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$editor_attribute_adjustment_edit->Page_Terminate();
?>

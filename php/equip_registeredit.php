...
$equip_register_edit = NULL; // Initialize page object first

class cequip_register_edit extends cequip_register {
	...
	// Page object name
	var $PageObjName = 'equip_register_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// SlotName
			$this->SlotName->SetDbValueDef($rsnew, $this->SlotName->CurrentValue, "", $this->SlotName->ReadOnly);

			// EquipName
			$this->EquipName->SetDbValueDef($rsnew, $this->EquipName->CurrentValue, "", $this->EquipName->ReadOnly);
...
// Create page object
if (!isset($equip_register_edit)) $equip_register_edit = new cequip_register_edit();

// Page init
$equip_register_edit->Page_Init();

// Page main
$equip_register_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$equip_register_edit->Page_Render();
?>
...
var CurrentForm = fequip_registeredit = new ew_Form("fequip_registeredit", "edit");

// Validate form
fequip_registeredit.Validate = function() {
...
fequip_registeredit.Form_CustomValidate = 
...
fequip_registeredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $equip_register_edit->ShowPageHeader(); ?>
<?php
$equip_register_edit->ShowMessage();
?>
<form name="fequip_registeredit" id="fequip_registeredit" class="<?php echo $equip_register_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($equip_register_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $equip_register_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="equip_register">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($equip_register_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($equip_register->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_equip_register_unid" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->unid->FldCaption() ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->unid->CellAttributes() ?>>
<span id="el_equip_register_unid">
<span<?php echo $equip_register->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $equip_register->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="equip_register" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($equip_register->unid->CurrentValue) ?>">
<?php echo $equip_register->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($equip_register->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_equip_register_u_id" for="x_u_id" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->u_id->CellAttributes() ?>>
...
<?php if ($equip_register->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_equip_register_acl_id" for="x_acl_id" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->acl_id->CellAttributes() ?>>
...
<?php if ($equip_register->User->Visible) { // User ?>
	<div id="r_User" class="form-group">
		<label id="elh_equip_register_User" for="x_User" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->User->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->User->CellAttributes() ?>>
...
<?php if ($equip_register->SlotName->Visible) { // SlotName ?>
	<div id="r_SlotName" class="form-group">
		<label id="elh_equip_register_SlotName" for="x_SlotName" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->SlotName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->SlotName->CellAttributes() ?>>
...
<?php if ($equip_register->EquipName->Visible) { // EquipName ?>
	<div id="r_EquipName" class="form-group">
		<label id="elh_equip_register_EquipName" for="x_EquipName" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->EquipName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->EquipName->CellAttributes() ?>>
...
<?php if ($equip_register->Add_HP->Visible) { // Add_HP ?>
	<div id="r_Add_HP" class="form-group">
		<label id="elh_equip_register_Add_HP" for="x_Add_HP" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_HP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_HP->CellAttributes() ?>>
...
<?php if ($equip_register->Add_MP->Visible) { // Add_MP ?>
	<div id="r_Add_MP" class="form-group">
		<label id="elh_equip_register_Add_MP" for="x_Add_MP" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_MP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_MP->CellAttributes() ?>>
...
<?php if ($equip_register->Add_Defense->Visible) { // Add_Defense ?>
	<div id="r_Add_Defense" class="form-group">
		<label id="elh_equip_register_Add_Defense" for="x_Add_Defense" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_Defense->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_Defense->CellAttributes() ?>>
...
<?php if ($equip_register->Add_Magic->Visible) { // Add_Magic ?>
	<div id="r_Add_Magic" class="form-group">
		<label id="elh_equip_register_Add_Magic" for="x_Add_Magic" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_Magic->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_Magic->CellAttributes() ?>>
...
<?php if ($equip_register->Add_AD->Visible) { // Add_AD ?>
	<div id="r_Add_AD" class="form-group">
		<label id="elh_equip_register_Add_AD" for="x_Add_AD" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_AD->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_AD->CellAttributes() ?>>
...
<?php if ($equip_register->Add_AP->Visible) { // Add_AP ?>
	<div id="r_Add_AP" class="form-group">
		<label id="elh_equip_register_Add_AP" for="x_Add_AP" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_AP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_AP->CellAttributes() ?>>
...
<?php if ($equip_register->Add_Hit->Visible) { // Add_Hit ?>
	<div id="r_Add_Hit" class="form-group">
		<label id="elh_equip_register_Add_Hit" for="x_Add_Hit" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_Hit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_Hit->CellAttributes() ?>>
...
<?php if ($equip_register->Add_Dodge->Visible) { // Add_Dodge ?>
	<div id="r_Add_Dodge" class="form-group">
		<label id="elh_equip_register_Add_Dodge" for="x_Add_Dodge" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_Dodge->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_Dodge->CellAttributes() ?>>
...
<?php if ($equip_register->Add_Crit->Visible) { // Add_Crit ?>
	<div id="r_Add_Crit" class="form-group">
		<label id="elh_equip_register_Add_Crit" for="x_Add_Crit" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_Crit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_Crit->CellAttributes() ?>>
...
<?php if ($equip_register->Add_AbsorbHP->Visible) { // Add_AbsorbHP ?>
	<div id="r_Add_AbsorbHP" class="form-group">
		<label id="elh_equip_register_Add_AbsorbHP" for="x_Add_AbsorbHP" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_AbsorbHP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_AbsorbHP->CellAttributes() ?>>
...
<?php if ($equip_register->Add_ADPTV->Visible) { // Add_ADPTV ?>
	<div id="r_Add_ADPTV" class="form-group">
		<label id="elh_equip_register_Add_ADPTV" for="x_Add_ADPTV" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_ADPTV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_ADPTV->CellAttributes() ?>>
...
<?php if ($equip_register->Add_ADPTR->Visible) { // Add_ADPTR ?>
	<div id="r_Add_ADPTR" class="form-group">
		<label id="elh_equip_register_Add_ADPTR" for="x_Add_ADPTR" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_ADPTR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_ADPTR->CellAttributes() ?>>
...
<?php if ($equip_register->Add_APPTR->Visible) { // Add_APPTR ?>
	<div id="r_Add_APPTR" class="form-group">
		<label id="elh_equip_register_Add_APPTR" for="x_Add_APPTR" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_APPTR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_APPTR->CellAttributes() ?>>
...
<?php if ($equip_register->Add_APPTV->Visible) { // Add_APPTV ?>
	<div id="r_Add_APPTV" class="form-group">
		<label id="elh_equip_register_Add_APPTV" for="x_Add_APPTV" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_APPTV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_APPTV->CellAttributes() ?>>
...
<?php if ($equip_register->Add_ImmuneDamage->Visible) { // Add_ImmuneDamage ?>
	<div id="r_Add_ImmuneDamage" class="form-group">
		<label id="elh_equip_register_Add_ImmuneDamage" for="x_Add_ImmuneDamage" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Add_ImmuneDamage->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Add_ImmuneDamage->CellAttributes() ?>>
...
<?php if ($equip_register->Special_Type->Visible) { // Special_Type ?>
	<div id="r_Special_Type" class="form-group">
		<label id="elh_equip_register_Special_Type" for="x_Special_Type" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Special_Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Special_Type->CellAttributes() ?>>
...
<?php if ($equip_register->Special_Value->Visible) { // Special_Value ?>
	<div id="r_Special_Value" class="form-group">
		<label id="elh_equip_register_Special_Value" for="x_Special_Value" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->Special_Value->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->Special_Value->CellAttributes() ?>>
...
<?php if ($equip_register->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_equip_register_DATETIME" for="x_DATETIME" class="<?php echo $equip_register_edit->LeftColumnClass ?>"><?php echo $equip_register->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_register_edit->RightColumnClass ?>"><div<?php echo $equip_register->DATETIME->CellAttributes() ?>>
...
<?php if (!$equip_register_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $equip_register_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $equip_register_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fequip_registeredit.Init();
</script>
<?php
$equip_register_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$equip_register_edit->Page_Terminate();
?>

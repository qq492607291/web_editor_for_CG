...
$config_composite_add = NULL; // Initialize page object first

class cconfig_composite_add extends cconfig_composite {
	...
	// Page object name
	var $PageObjName = 'config_composite_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_compositeview.php")
	...
	function LoadDefaultValues() {
		...
		$this->Produce->CurrentValue = NULL;
		$this->Produce->OldValue = $this->Produce->CurrentValue;
		$this->ConsumeGoods->CurrentValue = NULL;
		$this->ConsumeGoods->OldValue = $this->ConsumeGoods->CurrentValue;
		$this->ConsumeGold->CurrentValue = NULL;
		$this->ConsumeGold->OldValue = $this->ConsumeGold->CurrentValue;
		$this->ConsumeDiamond->CurrentValue = NULL;
		$this->ConsumeDiamond->OldValue = $this->ConsumeDiamond->CurrentValue;
	...
	function NewRow() {
		...
		$row['Produce'] = $this->Produce->CurrentValue;
		$row['ConsumeGoods'] = $this->ConsumeGoods->CurrentValue;
		$row['ConsumeGold'] = $this->ConsumeGold->CurrentValue;
		$row['ConsumeDiamond'] = $this->ConsumeDiamond->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// Produce
		$this->Produce->SetDbValueDef($rsnew, $this->Produce->CurrentValue, "", FALSE);

		// ConsumeGoods
		$this->ConsumeGoods->SetDbValueDef($rsnew, $this->ConsumeGoods->CurrentValue, "", FALSE);

		// ConsumeGold
		$this->ConsumeGold->SetDbValueDef($rsnew, $this->ConsumeGold->CurrentValue, "", FALSE);

		// ConsumeDiamond
		$this->ConsumeDiamond->SetDbValueDef($rsnew, $this->ConsumeDiamond->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($config_composite_add)) $config_composite_add = new cconfig_composite_add();

// Page init
$config_composite_add->Page_Init();

// Page main
$config_composite_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_composite_add->Page_Render();
?>
...
var CurrentForm = fconfig_compositeadd = new ew_Form("fconfig_compositeadd", "add");

// Validate form
fconfig_compositeadd.Validate = function() {
...
fconfig_compositeadd.Form_CustomValidate = 
...
fconfig_compositeadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_composite_add->ShowPageHeader(); ?>
<?php
$config_composite_add->ShowMessage();
?>
<form name="fconfig_compositeadd" id="fconfig_compositeadd" class="<?php echo $config_composite_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_composite_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_composite_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_composite">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_composite_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_composite->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_composite_u_id" for="x_u_id" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->u_id->CellAttributes() ?>>
...
<?php if ($config_composite->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_composite_acl_id" for="x_acl_id" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->acl_id->CellAttributes() ?>>
...
<?php if ($config_composite->Produce->Visible) { // Produce ?>
	<div id="r_Produce" class="form-group">
		<label id="elh_config_composite_Produce" for="x_Produce" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->Produce->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->Produce->CellAttributes() ?>>
...
<?php if ($config_composite->ConsumeGoods->Visible) { // ConsumeGoods ?>
	<div id="r_ConsumeGoods" class="form-group">
		<label id="elh_config_composite_ConsumeGoods" for="x_ConsumeGoods" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->ConsumeGoods->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->ConsumeGoods->CellAttributes() ?>>
...
<?php if ($config_composite->ConsumeGold->Visible) { // ConsumeGold ?>
	<div id="r_ConsumeGold" class="form-group">
		<label id="elh_config_composite_ConsumeGold" for="x_ConsumeGold" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->ConsumeGold->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->ConsumeGold->CellAttributes() ?>>
...
<?php if ($config_composite->ConsumeDiamond->Visible) { // ConsumeDiamond ?>
	<div id="r_ConsumeDiamond" class="form-group">
		<label id="elh_config_composite_ConsumeDiamond" for="x_ConsumeDiamond" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->ConsumeDiamond->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->ConsumeDiamond->CellAttributes() ?>>
...
<?php if ($config_composite->Success->Visible) { // Success ?>
	<div id="r_Success" class="form-group">
		<label id="elh_config_composite_Success" for="x_Success" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->Success->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->Success->CellAttributes() ?>>
...
<?php if ($config_composite->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_composite_DATETIME" for="x_DATETIME" class="<?php echo $config_composite_add->LeftColumnClass ?>"><?php echo $config_composite->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_composite_add->RightColumnClass ?>"><div<?php echo $config_composite->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_composite_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_composite_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_composite_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_compositeadd.Init();
</script>
<?php
$config_composite_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_composite_add->Page_Terminate();
?>

...
$ext_unioncity_add = NULL; // Initialize page object first

class cext_unioncity_add extends cext_unioncity {
	...
	// Page object name
	var $PageObjName = 'ext_unioncity_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ext_unioncityview.php")
...
// Create page object
if (!isset($ext_unioncity_add)) $ext_unioncity_add = new cext_unioncity_add();

// Page init
$ext_unioncity_add->Page_Init();

// Page main
$ext_unioncity_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_unioncity_add->Page_Render();
?>
...
var CurrentForm = fext_unioncityadd = new ew_Form("fext_unioncityadd", "add");

// Validate form
fext_unioncityadd.Validate = function() {
...
fext_unioncityadd.Form_CustomValidate = 
...
fext_unioncityadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_unioncity_add->ShowPageHeader(); ?>
<?php
$ext_unioncity_add->ShowMessage();
?>
<form name="fext_unioncityadd" id="fext_unioncityadd" class="<?php echo $ext_unioncity_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_unioncity_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_unioncity_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_unioncity">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($ext_unioncity_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($ext_unioncity->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_unioncity_u_id" for="x_u_id" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->u_id->CellAttributes() ?>>
...
<?php if ($ext_unioncity->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_unioncity_acl_id" for="x_acl_id" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->acl_id->CellAttributes() ?>>
...
<?php if ($ext_unioncity->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_ext_unioncity_Name" for="x_Name" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->Name->CellAttributes() ?>>
...
<?php if ($ext_unioncity->Location->Visible) { // Location ?>
	<div id="r_Location" class="form-group">
		<label id="elh_ext_unioncity_Location" for="x_Location" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->Location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->Location->CellAttributes() ?>>
...
<?php if ($ext_unioncity->Function->Visible) { // Function ?>
	<div id="r_Function" class="form-group">
		<label id="elh_ext_unioncity_Function" for="x_Function" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->Function->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->Function->CellAttributes() ?>>
...
<?php if ($ext_unioncity->Dialog->Visible) { // Dialog ?>
	<div id="r_Dialog" class="form-group">
		<label id="elh_ext_unioncity_Dialog" for="x_Dialog" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->Dialog->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->Dialog->CellAttributes() ?>>
...
<?php if ($ext_unioncity->Introduce->Visible) { // Introduce ?>
	<div id="r_Introduce" class="form-group">
		<label id="elh_ext_unioncity_Introduce" for="x_Introduce" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->Introduce->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->Introduce->CellAttributes() ?>>
...
<?php if ($ext_unioncity->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_unioncity_DATETIME" for="x_DATETIME" class="<?php echo $ext_unioncity_add->LeftColumnClass ?>"><?php echo $ext_unioncity->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_unioncity_add->RightColumnClass ?>"><div<?php echo $ext_unioncity->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_unioncity_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_unioncity_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_unioncity_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_unioncityadd.Init();
</script>
<?php
$ext_unioncity_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_unioncity_add->Page_Terminate();
?>

...
$shield_register_edit = NULL; // Initialize page object first

class cshield_register_edit extends cshield_register {
	...
	// Page object name
	var $PageObjName = 'shield_register_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// ID_Type
			$this->ID_Type->SetDbValueDef($rsnew, $this->ID_Type->CurrentValue, "", $this->ID_Type->ReadOnly);

			// Value
			$this->Value->SetDbValueDef($rsnew, $this->Value->CurrentValue, "", $this->Value->ReadOnly);

			// GetTime
			$this->GetTime->SetDbValueDef($rsnew, $this->GetTime->CurrentValue, "", $this->GetTime->ReadOnly);

			// Duration
			$this->Duration->SetDbValueDef($rsnew, $this->Duration->CurrentValue, "", $this->Duration->ReadOnly);

			// Pattern
			$this->Pattern->SetDbValueDef($rsnew, $this->Pattern->CurrentValue, "", $this->Pattern->ReadOnly);
...
// Create page object
if (!isset($shield_register_edit)) $shield_register_edit = new cshield_register_edit();

// Page init
$shield_register_edit->Page_Init();

// Page main
$shield_register_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$shield_register_edit->Page_Render();
?>
...
var CurrentForm = fshield_registeredit = new ew_Form("fshield_registeredit", "edit");

// Validate form
fshield_registeredit.Validate = function() {
...
fshield_registeredit.Form_CustomValidate = 
...
fshield_registeredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $shield_register_edit->ShowPageHeader(); ?>
<?php
$shield_register_edit->ShowMessage();
?>
<form name="fshield_registeredit" id="fshield_registeredit" class="<?php echo $shield_register_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($shield_register_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $shield_register_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="shield_register">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($shield_register_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($shield_register->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_shield_register_unid" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->unid->FldCaption() ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->unid->CellAttributes() ?>>
<span id="el_shield_register_unid">
<span<?php echo $shield_register->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $shield_register->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="shield_register" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($shield_register->unid->CurrentValue) ?>">
<?php echo $shield_register->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($shield_register->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_shield_register_u_id" for="x_u_id" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->u_id->CellAttributes() ?>>
...
<?php if ($shield_register->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_shield_register_acl_id" for="x_acl_id" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->acl_id->CellAttributes() ?>>
...
<?php if ($shield_register->ID->Visible) { // ID ?>
	<div id="r_ID" class="form-group">
		<label id="elh_shield_register_ID" for="x_ID" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->ID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->ID->CellAttributes() ?>>
...
<?php if ($shield_register->ID_Type->Visible) { // ID_Type ?>
	<div id="r_ID_Type" class="form-group">
		<label id="elh_shield_register_ID_Type" for="x_ID_Type" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->ID_Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->ID_Type->CellAttributes() ?>>
...
<?php if ($shield_register->Value->Visible) { // Value ?>
	<div id="r_Value" class="form-group">
		<label id="elh_shield_register_Value" for="x_Value" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->Value->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->Value->CellAttributes() ?>>
...
<?php if ($shield_register->GetTime->Visible) { // GetTime ?>
	<div id="r_GetTime" class="form-group">
		<label id="elh_shield_register_GetTime" for="x_GetTime" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->GetTime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->GetTime->CellAttributes() ?>>
...
<?php if ($shield_register->Duration->Visible) { // Duration ?>
	<div id="r_Duration" class="form-group">
		<label id="elh_shield_register_Duration" for="x_Duration" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->Duration->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->Duration->CellAttributes() ?>>
...
<?php if ($shield_register->Pattern->Visible) { // Pattern ?>
	<div id="r_Pattern" class="form-group">
		<label id="elh_shield_register_Pattern" for="x_Pattern" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->Pattern->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->Pattern->CellAttributes() ?>>
...
<?php if ($shield_register->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_shield_register_DATETIME" for="x_DATETIME" class="<?php echo $shield_register_edit->LeftColumnClass ?>"><?php echo $shield_register->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $shield_register_edit->RightColumnClass ?>"><div<?php echo $shield_register->DATETIME->CellAttributes() ?>>
...
<?php if (!$shield_register_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $shield_register_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $shield_register_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fshield_registeredit.Init();
</script>
<?php
$shield_register_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$shield_register_edit->Page_Terminate();
?>

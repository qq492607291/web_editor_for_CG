...
$dynamicattributes_register_edit = NULL; // Initialize page object first

class cdynamicattributes_register_edit extends cdynamicattributes_register {
	...
	// Page object name
	var $PageObjName = 'dynamicattributes_register_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// AttName
			$this->AttName->SetDbValueDef($rsnew, $this->AttName->CurrentValue, "", $this->AttName->ReadOnly);

			// AttValue
			$this->AttValue->SetDbValueDef($rsnew, $this->AttValue->CurrentValue, "", $this->AttValue->ReadOnly);

			// AttInvalidTime
			$this->AttInvalidTime->SetDbValueDef($rsnew, $this->AttInvalidTime->CurrentValue, "", $this->AttInvalidTime->ReadOnly);
...
// Create page object
if (!isset($dynamicattributes_register_edit)) $dynamicattributes_register_edit = new cdynamicattributes_register_edit();

// Page init
$dynamicattributes_register_edit->Page_Init();

// Page main
$dynamicattributes_register_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$dynamicattributes_register_edit->Page_Render();
?>
...
var CurrentForm = fdynamicattributes_registeredit = new ew_Form("fdynamicattributes_registeredit", "edit");

// Validate form
fdynamicattributes_registeredit.Validate = function() {
...
fdynamicattributes_registeredit.Form_CustomValidate = 
...
fdynamicattributes_registeredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $dynamicattributes_register_edit->ShowPageHeader(); ?>
<?php
$dynamicattributes_register_edit->ShowMessage();
?>
<form name="fdynamicattributes_registeredit" id="fdynamicattributes_registeredit" class="<?php echo $dynamicattributes_register_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($dynamicattributes_register_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $dynamicattributes_register_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="dynamicattributes_register">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($dynamicattributes_register_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($dynamicattributes_register->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_dynamicattributes_register_unid" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->unid->FldCaption() ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->unid->CellAttributes() ?>>
<span id="el_dynamicattributes_register_unid">
<span<?php echo $dynamicattributes_register->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $dynamicattributes_register->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="dynamicattributes_register" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($dynamicattributes_register->unid->CurrentValue) ?>">
<?php echo $dynamicattributes_register->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($dynamicattributes_register->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_dynamicattributes_register_u_id" for="x_u_id" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->u_id->CellAttributes() ?>>
...
<?php if ($dynamicattributes_register->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_dynamicattributes_register_acl_id" for="x_acl_id" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->acl_id->CellAttributes() ?>>
...
<?php if ($dynamicattributes_register->User->Visible) { // User ?>
	<div id="r_User" class="form-group">
		<label id="elh_dynamicattributes_register_User" for="x_User" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->User->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->User->CellAttributes() ?>>
...
<?php if ($dynamicattributes_register->AttName->Visible) { // AttName ?>
	<div id="r_AttName" class="form-group">
		<label id="elh_dynamicattributes_register_AttName" for="x_AttName" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->AttName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->AttName->CellAttributes() ?>>
...
<?php if ($dynamicattributes_register->AttValue->Visible) { // AttValue ?>
	<div id="r_AttValue" class="form-group">
		<label id="elh_dynamicattributes_register_AttValue" for="x_AttValue" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->AttValue->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->AttValue->CellAttributes() ?>>
...
<?php if ($dynamicattributes_register->AttInvalidTime->Visible) { // AttInvalidTime ?>
	<div id="r_AttInvalidTime" class="form-group">
		<label id="elh_dynamicattributes_register_AttInvalidTime" for="x_AttInvalidTime" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->AttInvalidTime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->AttInvalidTime->CellAttributes() ?>>
...
<?php if ($dynamicattributes_register->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_dynamicattributes_register_DATETIME" for="x_DATETIME" class="<?php echo $dynamicattributes_register_edit->LeftColumnClass ?>"><?php echo $dynamicattributes_register->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dynamicattributes_register_edit->RightColumnClass ?>"><div<?php echo $dynamicattributes_register->DATETIME->CellAttributes() ?>>
...
<?php if (!$dynamicattributes_register_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $dynamicattributes_register_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $dynamicattributes_register_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fdynamicattributes_registeredit.Init();
</script>
<?php
$dynamicattributes_register_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$dynamicattributes_register_edit->Page_Terminate();
?>

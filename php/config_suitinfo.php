...
//
// Table class for config_suit
//
class cconfig_suit extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'config_suit';
		$this->TableName = 'config_suit';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`config_suit`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('config_suit', 'config_suit', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('config_suit', 'config_suit', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('config_suit', 'config_suit', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('config_suit', 'config_suit', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// Add_HP
		$this->Add_HP = new cField('config_suit', 'config_suit', 'x_Add_HP', 'Add_HP', '`Add_HP`', '`Add_HP`', 201, -1, FALSE, '`Add_HP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_HP->Sortable = TRUE; // Allow sort
		$this->fields['Add_HP'] = &$this->Add_HP;

		// Add_MP
		$this->Add_MP = new cField('config_suit', 'config_suit', 'x_Add_MP', 'Add_MP', '`Add_MP`', '`Add_MP`', 201, -1, FALSE, '`Add_MP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_MP->Sortable = TRUE; // Allow sort
		$this->fields['Add_MP'] = &$this->Add_MP;

		// Add_Defense
		$this->Add_Defense = new cField('config_suit', 'config_suit', 'x_Add_Defense', 'Add_Defense', '`Add_Defense`', '`Add_Defense`', 201, -1, FALSE, '`Add_Defense`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_Defense->Sortable = TRUE; // Allow sort
		$this->fields['Add_Defense'] = &$this->Add_Defense;

		// Add_Magic
		$this->Add_Magic = new cField('config_suit', 'config_suit', 'x_Add_Magic', 'Add_Magic', '`Add_Magic`', '`Add_Magic`', 201, -1, FALSE, '`Add_Magic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_Magic->Sortable = TRUE; // Allow sort
		$this->fields['Add_Magic'] = &$this->Add_Magic;

		// Add_AD
		$this->Add_AD = new cField('config_suit', 'config_suit', 'x_Add_AD', 'Add_AD', '`Add_AD`', '`Add_AD`', 201, -1, FALSE, '`Add_AD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_AD->Sortable = TRUE; // Allow sort
		$this->fields['Add_AD'] = &$this->Add_AD;

		// Add_AP
		$this->Add_AP = new cField('config_suit', 'config_suit', 'x_Add_AP', 'Add_AP', '`Add_AP`', '`Add_AP`', 201, -1, FALSE, '`Add_AP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_AP->Sortable = TRUE; // Allow sort
		$this->fields['Add_AP'] = &$this->Add_AP;

		// Add_Hit
		$this->Add_Hit = new cField('config_suit', 'config_suit', 'x_Add_Hit', 'Add_Hit', '`Add_Hit`', '`Add_Hit`', 201, -1, FALSE, '`Add_Hit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_Hit->Sortable = TRUE; // Allow sort
		$this->fields['Add_Hit'] = &$this->Add_Hit;

		// Add_Dodge
		$this->Add_Dodge = new cField('config_suit', 'config_suit', 'x_Add_Dodge', 'Add_Dodge', '`Add_Dodge`', '`Add_Dodge`', 201, -1, FALSE, '`Add_Dodge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_Dodge->Sortable = TRUE; // Allow sort
		$this->fields['Add_Dodge'] = &$this->Add_Dodge;

		// Add_Crit
		$this->Add_Crit = new cField('config_suit', 'config_suit', 'x_Add_Crit', 'Add_Crit', '`Add_Crit`', '`Add_Crit`', 201, -1, FALSE, '`Add_Crit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_Crit->Sortable = TRUE; // Allow sort
		$this->fields['Add_Crit'] = &$this->Add_Crit;

		// Add_AbsorbHP
		$this->Add_AbsorbHP = new cField('config_suit', 'config_suit', 'x_Add_AbsorbHP', 'Add_AbsorbHP', '`Add_AbsorbHP`', '`Add_AbsorbHP`', 201, -1, FALSE, '`Add_AbsorbHP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_AbsorbHP->Sortable = TRUE; // Allow sort
		$this->fields['Add_AbsorbHP'] = &$this->Add_AbsorbHP;

		// Add_ADPTV
		$this->Add_ADPTV = new cField('config_suit', 'config_suit', 'x_Add_ADPTV', 'Add_ADPTV', '`Add_ADPTV`', '`Add_ADPTV`', 201, -1, FALSE, '`Add_ADPTV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_ADPTV->Sortable = TRUE; // Allow sort
		$this->fields['Add_ADPTV'] = &$this->Add_ADPTV;

		// Add_ADPTR
		$this->Add_ADPTR = new cField('config_suit', 'config_suit', 'x_Add_ADPTR', 'Add_ADPTR', '`Add_ADPTR`', '`Add_ADPTR`', 201, -1, FALSE, '`Add_ADPTR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_ADPTR->Sortable = TRUE; // Allow sort
		$this->fields['Add_ADPTR'] = &$this->Add_ADPTR;

		// Add_APPTR
		$this->Add_APPTR = new cField('config_suit', 'config_suit', 'x_Add_APPTR', 'Add_APPTR', '`Add_APPTR`', '`Add_APPTR`', 201, -1, FALSE, '`Add_APPTR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_APPTR->Sortable = TRUE; // Allow sort
		$this->fields['Add_APPTR'] = &$this->Add_APPTR;

		// Add_APPTV
		$this->Add_APPTV = new cField('config_suit', 'config_suit', 'x_Add_APPTV', 'Add_APPTV', '`Add_APPTV`', '`Add_APPTV`', 201, -1, FALSE, '`Add_APPTV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_APPTV->Sortable = TRUE; // Allow sort
		$this->fields['Add_APPTV'] = &$this->Add_APPTV;

		// Add_ImmuneDamage
		$this->Add_ImmuneDamage = new cField('config_suit', 'config_suit', 'x_Add_ImmuneDamage', 'Add_ImmuneDamage', '`Add_ImmuneDamage`', '`Add_ImmuneDamage`', 201, -1, FALSE, '`Add_ImmuneDamage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Add_ImmuneDamage->Sortable = TRUE; // Allow sort
		$this->fields['Add_ImmuneDamage'] = &$this->Add_ImmuneDamage;

		// Special_Type
		$this->Special_Type = new cField('config_suit', 'config_suit', 'x_Special_Type', 'Special_Type', '`Special_Type`', '`Special_Type`', 201, -1, FALSE, '`Special_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Special_Type->Sortable = TRUE; // Allow sort
		$this->fields['Special_Type'] = &$this->Special_Type;

		// Special_Value
		$this->Special_Value = new cField('config_suit', 'config_suit', 'x_Special_Value', 'Special_Value', '`Special_Value`', '`Special_Value`', 201, -1, FALSE, '`Special_Value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Special_Value->Sortable = TRUE; // Allow sort
		$this->fields['Special_Value'] = &$this->Special_Value;

		// DATETIME
		$this->DATETIME = new cField('config_suit', 'config_suit', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`config_suit`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "config_suitedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "config_suitadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("config_suitview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("config_suitview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "config_suitadd.php?" . $this->UrlParm($parm);
		else
			$url = "config_suitadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("config_suitedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("config_suitadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("config_suitdelete.php", $this->UrlParm());
	}

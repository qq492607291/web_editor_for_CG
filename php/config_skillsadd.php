...
$config_skills_add = NULL; // Initialize page object first

class cconfig_skills_add extends cconfig_skills {
	...
	// Page object name
	var $PageObjName = 'config_skills_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_skillsview.php")
	...
	function LoadDefaultValues() {
		...
		$this->EO->CurrentValue = NULL;
		$this->EO->OldValue = $this->EO->CurrentValue;
		$this->LV->CurrentValue = NULL;
		$this->LV->OldValue = $this->LV->CurrentValue;
		$this->ConsumeType->CurrentValue = NULL;
		$this->ConsumeType->OldValue = $this->ConsumeType->CurrentValue;
		$this->Cooling->CurrentValue = NULL;
		$this->Cooling->OldValue = $this->Cooling->CurrentValue;
		$this->Accurate->CurrentValue = NULL;
		$this->Accurate->OldValue = $this->Accurate->CurrentValue;
		...
		$this->ACS->CurrentValue = NULL;
		$this->ACS->OldValue = $this->ACS->CurrentValue;
		$this->Shield->CurrentValue = NULL;
		$this->Shield->OldValue = $this->Shield->CurrentValue;
		$this->IgnoreShield->CurrentValue = NULL;
		$this->IgnoreShield->OldValue = $this->IgnoreShield->CurrentValue;
		$this->IgnoreIM->CurrentValue = NULL;
		$this->IgnoreIM->OldValue = $this->IgnoreIM->CurrentValue;
		$this->IgnoreRE->CurrentValue = NULL;
		$this->IgnoreRE->OldValue = $this->IgnoreRE->CurrentValue;
		$this->BanAbsorb->CurrentValue = NULL;
		$this->BanAbsorb->OldValue = $this->BanAbsorb->CurrentValue;
		$this->BanMultipleShot->CurrentValue = NULL;
		$this->BanMultipleShot->OldValue = $this->BanMultipleShot->CurrentValue;
		$this->ProhibitUO->CurrentValue = NULL;
		$this->ProhibitUO->OldValue = $this->ProhibitUO->CurrentValue;
		$this->ConsumableGoods->CurrentValue = NULL;
		$this->ConsumableGoods->OldValue = $this->ConsumableGoods->CurrentValue;
		$this->Continued_Round->CurrentValue = NULL;
		$this->Continued_Round->OldValue = $this->Continued_Round->CurrentValue;
		$this->Continued_Type->CurrentValue = NULL;
		$this->Continued_Type->OldValue = $this->Continued_Type->CurrentValue;
		$this->Continued_Effect->CurrentValue = NULL;
		$this->Continued_Effect->OldValue = $this->Continued_Effect->CurrentValue;
	...
	function NewRow() {
		...
		$row['EO'] = $this->EO->CurrentValue;
		$row['LV'] = $this->LV->CurrentValue;
		$row['ConsumeType'] = $this->ConsumeType->CurrentValue;
		$row['Cooling'] = $this->Cooling->CurrentValue;
		$row['Accurate'] = $this->Accurate->CurrentValue;
		$row['AttackTips'] = $this->AttackTips->CurrentValue;
		$row['Introduce'] = $this->Introduce->CurrentValue;
		$row['ACS'] = $this->ACS->CurrentValue;
		$row['Shield'] = $this->Shield->CurrentValue;
		$row['IgnoreShield'] = $this->IgnoreShield->CurrentValue;
		$row['IgnoreIM'] = $this->IgnoreIM->CurrentValue;
		$row['IgnoreRE'] = $this->IgnoreRE->CurrentValue;
		$row['BanAbsorb'] = $this->BanAbsorb->CurrentValue;
		$row['BanMultipleShot'] = $this->BanMultipleShot->CurrentValue;
		$row['ProhibitUO'] = $this->ProhibitUO->CurrentValue;
		$row['ConsumableGoods'] = $this->ConsumableGoods->CurrentValue;
		$row['Continued_Round'] = $this->Continued_Round->CurrentValue;
		$row['Continued_Type'] = $this->Continued_Type->CurrentValue;
		$row['Continued_Effect'] = $this->Continued_Effect->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// EO
		$this->EO->SetDbValueDef($rsnew, $this->EO->CurrentValue, "", FALSE);

		// LV
		$this->LV->SetDbValueDef($rsnew, $this->LV->CurrentValue, "", FALSE);

		// ConsumeType
		$this->ConsumeType->SetDbValueDef($rsnew, $this->ConsumeType->CurrentValue, "", FALSE);

		// Cooling
		$this->Cooling->SetDbValueDef($rsnew, $this->Cooling->CurrentValue, "", FALSE);

		// Accurate
		$this->Accurate->SetDbValueDef($rsnew, $this->Accurate->CurrentValue, "", FALSE);
		...
		// ACS
		$this->ACS->SetDbValueDef($rsnew, $this->ACS->CurrentValue, "", FALSE);

		// Shield
		$this->Shield->SetDbValueDef($rsnew, $this->Shield->CurrentValue, "", FALSE);

		// IgnoreShield
		$this->IgnoreShield->SetDbValueDef($rsnew, $this->IgnoreShield->CurrentValue, "", FALSE);

		// IgnoreIM
		$this->IgnoreIM->SetDbValueDef($rsnew, $this->IgnoreIM->CurrentValue, "", FALSE);

		// IgnoreRE
		$this->IgnoreRE->SetDbValueDef($rsnew, $this->IgnoreRE->CurrentValue, "", FALSE);

		// BanAbsorb
		$this->BanAbsorb->SetDbValueDef($rsnew, $this->BanAbsorb->CurrentValue, "", FALSE);

		// BanMultipleShot
		$this->BanMultipleShot->SetDbValueDef($rsnew, $this->BanMultipleShot->CurrentValue, "", FALSE);

		// ProhibitUO
		$this->ProhibitUO->SetDbValueDef($rsnew, $this->ProhibitUO->CurrentValue, "", FALSE);

		// ConsumableGoods
		$this->ConsumableGoods->SetDbValueDef($rsnew, $this->ConsumableGoods->CurrentValue, "", FALSE);

		// Continued_Round
		$this->Continued_Round->SetDbValueDef($rsnew, $this->Continued_Round->CurrentValue, "", FALSE);

		// Continued_Type
		$this->Continued_Type->SetDbValueDef($rsnew, $this->Continued_Type->CurrentValue, "", FALSE);

		// Continued_Effect
		$this->Continued_Effect->SetDbValueDef($rsnew, $this->Continued_Effect->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($config_skills_add)) $config_skills_add = new cconfig_skills_add();

// Page init
$config_skills_add->Page_Init();

// Page main
$config_skills_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_skills_add->Page_Render();
?>
...
var CurrentForm = fconfig_skillsadd = new ew_Form("fconfig_skillsadd", "add");

// Validate form
fconfig_skillsadd.Validate = function() {
...
fconfig_skillsadd.Form_CustomValidate = 
...
fconfig_skillsadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_skills_add->ShowPageHeader(); ?>
<?php
$config_skills_add->ShowMessage();
?>
<form name="fconfig_skillsadd" id="fconfig_skillsadd" class="<?php echo $config_skills_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_skills_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_skills_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_skills">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_skills_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_skills->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_skills_u_id" for="x_u_id" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->u_id->CellAttributes() ?>>
...
<?php if ($config_skills->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_skills_acl_id" for="x_acl_id" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->acl_id->CellAttributes() ?>>
...
<?php if ($config_skills->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_config_skills_Name" for="x_Name" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Name->CellAttributes() ?>>
...
<?php if ($config_skills->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group">
		<label id="elh_config_skills_Type" for="x_Type" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Type->CellAttributes() ?>>
...
<?php if ($config_skills->Consume->Visible) { // Consume ?>
	<div id="r_Consume" class="form-group">
		<label id="elh_config_skills_Consume" for="x_Consume" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Consume->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Consume->CellAttributes() ?>>
...
<?php if ($config_skills->Effect->Visible) { // Effect ?>
	<div id="r_Effect" class="form-group">
		<label id="elh_config_skills_Effect" for="x_Effect" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Effect->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Effect->CellAttributes() ?>>
...
<?php if ($config_skills->EO->Visible) { // EO ?>
	<div id="r_EO" class="form-group">
		<label id="elh_config_skills_EO" for="x_EO" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->EO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->EO->CellAttributes() ?>>
...
<?php if ($config_skills->LV->Visible) { // LV ?>
	<div id="r_LV" class="form-group">
		<label id="elh_config_skills_LV" for="x_LV" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->LV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->LV->CellAttributes() ?>>
...
<?php if ($config_skills->ConsumeType->Visible) { // ConsumeType ?>
	<div id="r_ConsumeType" class="form-group">
		<label id="elh_config_skills_ConsumeType" for="x_ConsumeType" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->ConsumeType->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->ConsumeType->CellAttributes() ?>>
...
<?php if ($config_skills->Cooling->Visible) { // Cooling ?>
	<div id="r_Cooling" class="form-group">
		<label id="elh_config_skills_Cooling" for="x_Cooling" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Cooling->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Cooling->CellAttributes() ?>>
...
<?php if ($config_skills->Accurate->Visible) { // Accurate ?>
	<div id="r_Accurate" class="form-group">
		<label id="elh_config_skills_Accurate" for="x_Accurate" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Accurate->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Accurate->CellAttributes() ?>>
...
<?php if ($config_skills->AttackTips->Visible) { // AttackTips ?>
	<div id="r_AttackTips" class="form-group">
		<label id="elh_config_skills_AttackTips" for="x_AttackTips" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->AttackTips->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->AttackTips->CellAttributes() ?>>
...
<?php if ($config_skills->Introduce->Visible) { // Introduce ?>
	<div id="r_Introduce" class="form-group">
		<label id="elh_config_skills_Introduce" for="x_Introduce" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Introduce->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Introduce->CellAttributes() ?>>
...
<?php if ($config_skills->ACS->Visible) { // ACS ?>
	<div id="r_ACS" class="form-group">
		<label id="elh_config_skills_ACS" for="x_ACS" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->ACS->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->ACS->CellAttributes() ?>>
...
<?php if ($config_skills->Shield->Visible) { // Shield ?>
	<div id="r_Shield" class="form-group">
		<label id="elh_config_skills_Shield" for="x_Shield" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Shield->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Shield->CellAttributes() ?>>
...
<?php if ($config_skills->IgnoreShield->Visible) { // IgnoreShield ?>
	<div id="r_IgnoreShield" class="form-group">
		<label id="elh_config_skills_IgnoreShield" for="x_IgnoreShield" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->IgnoreShield->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->IgnoreShield->CellAttributes() ?>>
...
<?php if ($config_skills->IgnoreIM->Visible) { // IgnoreIM ?>
	<div id="r_IgnoreIM" class="form-group">
		<label id="elh_config_skills_IgnoreIM" for="x_IgnoreIM" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->IgnoreIM->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->IgnoreIM->CellAttributes() ?>>
...
<?php if ($config_skills->IgnoreRE->Visible) { // IgnoreRE ?>
	<div id="r_IgnoreRE" class="form-group">
		<label id="elh_config_skills_IgnoreRE" for="x_IgnoreRE" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->IgnoreRE->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->IgnoreRE->CellAttributes() ?>>
...
<?php if ($config_skills->BanAbsorb->Visible) { // BanAbsorb ?>
	<div id="r_BanAbsorb" class="form-group">
		<label id="elh_config_skills_BanAbsorb" for="x_BanAbsorb" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->BanAbsorb->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->BanAbsorb->CellAttributes() ?>>
...
<?php if ($config_skills->BanMultipleShot->Visible) { // BanMultipleShot ?>
	<div id="r_BanMultipleShot" class="form-group">
		<label id="elh_config_skills_BanMultipleShot" for="x_BanMultipleShot" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->BanMultipleShot->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->BanMultipleShot->CellAttributes() ?>>
...
<?php if ($config_skills->ProhibitUO->Visible) { // ProhibitUO ?>
	<div id="r_ProhibitUO" class="form-group">
		<label id="elh_config_skills_ProhibitUO" for="x_ProhibitUO" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->ProhibitUO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->ProhibitUO->CellAttributes() ?>>
...
<?php if ($config_skills->ConsumableGoods->Visible) { // ConsumableGoods ?>
	<div id="r_ConsumableGoods" class="form-group">
		<label id="elh_config_skills_ConsumableGoods" for="x_ConsumableGoods" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->ConsumableGoods->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->ConsumableGoods->CellAttributes() ?>>
...
<?php if ($config_skills->Continued_Round->Visible) { // Continued_Round ?>
	<div id="r_Continued_Round" class="form-group">
		<label id="elh_config_skills_Continued_Round" for="x_Continued_Round" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Continued_Round->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Continued_Round->CellAttributes() ?>>
...
<?php if ($config_skills->Continued_Type->Visible) { // Continued_Type ?>
	<div id="r_Continued_Type" class="form-group">
		<label id="elh_config_skills_Continued_Type" for="x_Continued_Type" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Continued_Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Continued_Type->CellAttributes() ?>>
...
<?php if ($config_skills->Continued_Effect->Visible) { // Continued_Effect ?>
	<div id="r_Continued_Effect" class="form-group">
		<label id="elh_config_skills_Continued_Effect" for="x_Continued_Effect" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->Continued_Effect->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->Continued_Effect->CellAttributes() ?>>
...
<?php if ($config_skills->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_skills_DATETIME" for="x_DATETIME" class="<?php echo $config_skills_add->LeftColumnClass ?>"><?php echo $config_skills->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_skills_add->RightColumnClass ?>"><div<?php echo $config_skills->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_skills_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_skills_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_skills_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_skillsadd.Init();
</script>
<?php
$config_skills_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_skills_add->Page_Terminate();
?>

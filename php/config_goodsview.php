...
$config_goods_view = NULL; // Initialize page object first

class cconfig_goods_view extends cconfig_goods {
	...
	// Page object name
	var $PageObjName = 'config_goods_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["unid"] <> "") {
				...
				$sReturnUrl = "config_goodslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "config_goodslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "config_goodslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($config_goods_view)) $config_goods_view = new cconfig_goods_view();

// Page init
$config_goods_view->Page_Init();

// Page main
$config_goods_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_goods_view->Page_Render();
?>
...
var CurrentForm = fconfig_goodsview = new ew_Form("fconfig_goodsview", "view");

// Form_CustomValidate event
fconfig_goodsview.Form_CustomValidate = 
...
fconfig_goodsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $config_goods_view->ExportOptions->Render("body") ?>
<?php
	foreach ($config_goods_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $config_goods_view->ShowPageHeader(); ?>
<?php
$config_goods_view->ShowMessage();
?>
<form name="fconfig_goodsview" id="fconfig_goodsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_goods_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_goods_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_goods">
<input type="hidden" name="modal" value="<?php echo intval($config_goods_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($config_goods->unid->Visible) { // unid ?>
	<tr id="r_unid">
		<td class="col-sm-2"><span id="elh_config_goods_unid"><?php echo $config_goods->unid->FldCaption() ?></span></td>
		<td data-name="unid"<?php echo $config_goods->unid->CellAttributes() ?>>
<span id="el_config_goods_unid">
<span<?php echo $config_goods->unid->ViewAttributes() ?>>
<?php echo $config_goods->unid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->u_id->Visible) { // u_id ?>
	<tr id="r_u_id">
		<td class="col-sm-2"><span id="elh_config_goods_u_id"><?php echo $config_goods->u_id->FldCaption() ?></span></td>
		<td data-name="u_id"<?php echo $config_goods->u_id->CellAttributes() ?>>
<span id="el_config_goods_u_id">
<span<?php echo $config_goods->u_id->ViewAttributes() ?>>
<?php echo $config_goods->u_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->acl_id->Visible) { // acl_id ?>
	<tr id="r_acl_id">
		<td class="col-sm-2"><span id="elh_config_goods_acl_id"><?php echo $config_goods->acl_id->FldCaption() ?></span></td>
		<td data-name="acl_id"<?php echo $config_goods->acl_id->CellAttributes() ?>>
<span id="el_config_goods_acl_id">
<span<?php echo $config_goods->acl_id->ViewAttributes() ?>>
<?php echo $config_goods->acl_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->ID->Visible) { // ID ?>
	<tr id="r_ID">
		<td class="col-sm-2"><span id="elh_config_goods_ID"><?php echo $config_goods->ID->FldCaption() ?></span></td>
...
<?php echo $config_goods->ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->Name->Visible) { // Name ?>
	<tr id="r_Name">
		<td class="col-sm-2"><span id="elh_config_goods_Name"><?php echo $config_goods->Name->FldCaption() ?></span></td>
...
<?php echo $config_goods->Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->Type->Visible) { // Type ?>
	<tr id="r_Type">
		<td class="col-sm-2"><span id="elh_config_goods_Type"><?php echo $config_goods->Type->FldCaption() ?></span></td>
...
<?php echo $config_goods->Type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->Basic->Visible) { // Basic ?>
	<tr id="r_Basic">
		<td class="col-sm-2"><span id="elh_config_goods_Basic"><?php echo $config_goods->Basic->FldCaption() ?></span></td>
...
<?php echo $config_goods->Basic->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($config_goods->LtemData->Visible) { // LtemData ?>
	<tr id="r_LtemData">
		<td class="col-sm-2"><span id="elh_config_goods_LtemData"><?php echo $config_goods->LtemData->FldCaption() ?></span></td>
...
<?php echo $config_goods->LtemData->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->Introduce->Visible) { // Introduce ?>
	<tr id="r_Introduce">
		<td class="col-sm-2"><span id="elh_config_goods_Introduce"><?php echo $config_goods->Introduce->FldCaption() ?></span></td>
...
<?php echo $config_goods->Introduce->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_goods->DATETIME->Visible) { // DATETIME ?>
	<tr id="r_DATETIME">
		<td class="col-sm-2"><span id="elh_config_goods_DATETIME"><?php echo $config_goods->DATETIME->FldCaption() ?></span></td>
		<td data-name="DATETIME"<?php echo $config_goods->DATETIME->CellAttributes() ?>>
<span id="el_config_goods_DATETIME">
<span<?php echo $config_goods->DATETIME->ViewAttributes() ?>>
<?php echo $config_goods->DATETIME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fconfig_goodsview.Init();
</script>
<?php
$config_goods_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_goods_view->Page_Terminate();
?>

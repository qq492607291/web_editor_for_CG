...
$config_union_add = NULL; // Initialize page object first

class cconfig_union_add extends cconfig_union {
	...
	// Page object name
	var $PageObjName = 'config_union_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_unionview.php")
	...
	function LoadDefaultValues() {
		...
		$this->NeedEXP->CurrentValue = NULL;
		$this->NeedEXP->OldValue = $this->NeedEXP->CurrentValue;
		$this->CDR->CurrentValue = NULL;
		$this->CDR->OldValue = $this->CDR->CurrentValue;
		$this->LimitLV->CurrentValue = NULL;
		$this->LimitLV->OldValue = $this->LimitLV->CurrentValue;
	...
	function NewRow() {
		...
		$row['EXP'] = $this->EXP->CurrentValue;
		$row['NeedEXP'] = $this->NeedEXP->CurrentValue;
		$row['CDR'] = $this->CDR->CurrentValue;
		$row['LimitLV'] = $this->LimitLV->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// NeedEXP
		$this->NeedEXP->SetDbValueDef($rsnew, $this->NeedEXP->CurrentValue, "", FALSE);

		// CDR
		$this->CDR->SetDbValueDef($rsnew, $this->CDR->CurrentValue, "", FALSE);

		// LimitLV
		$this->LimitLV->SetDbValueDef($rsnew, $this->LimitLV->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($config_union_add)) $config_union_add = new cconfig_union_add();

// Page init
$config_union_add->Page_Init();

// Page main
$config_union_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_union_add->Page_Render();
?>
...
var CurrentForm = fconfig_unionadd = new ew_Form("fconfig_unionadd", "add");

// Validate form
fconfig_unionadd.Validate = function() {
...
fconfig_unionadd.Form_CustomValidate = 
...
fconfig_unionadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_union_add->ShowPageHeader(); ?>
<?php
$config_union_add->ShowMessage();
?>
<form name="fconfig_unionadd" id="fconfig_unionadd" class="<?php echo $config_union_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_union_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_union_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_union">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_union_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_union->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_union_u_id" for="x_u_id" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->u_id->CellAttributes() ?>>
...
<?php if ($config_union->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_union_acl_id" for="x_acl_id" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->acl_id->CellAttributes() ?>>
...
<?php if ($config_union->ID->Visible) { // ID ?>
	<div id="r_ID" class="form-group">
		<label id="elh_config_union_ID" for="x_ID" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->ID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->ID->CellAttributes() ?>>
...
<?php if ($config_union->LV->Visible) { // LV ?>
	<div id="r_LV" class="form-group">
		<label id="elh_config_union_LV" for="x_LV" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->LV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->LV->CellAttributes() ?>>
...
<?php if ($config_union->EXP->Visible) { // EXP ?>
	<div id="r_EXP" class="form-group">
		<label id="elh_config_union_EXP" for="x_EXP" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->EXP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->EXP->CellAttributes() ?>>
...
<?php if ($config_union->NeedEXP->Visible) { // NeedEXP ?>
	<div id="r_NeedEXP" class="form-group">
		<label id="elh_config_union_NeedEXP" for="x_NeedEXP" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->NeedEXP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->NeedEXP->CellAttributes() ?>>
...
<?php if ($config_union->CDR->Visible) { // CDR ?>
	<div id="r_CDR" class="form-group">
		<label id="elh_config_union_CDR" for="x_CDR" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->CDR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->CDR->CellAttributes() ?>>
...
<?php if ($config_union->LimitLV->Visible) { // LimitLV ?>
	<div id="r_LimitLV" class="form-group">
		<label id="elh_config_union_LimitLV" for="x_LimitLV" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->LimitLV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->LimitLV->CellAttributes() ?>>
...
<?php if ($config_union->Data->Visible) { // Data ?>
	<div id="r_Data" class="form-group">
		<label id="elh_config_union_Data" for="x_Data" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->Data->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->Data->CellAttributes() ?>>
...
<?php if ($config_union->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_union_DATETIME" for="x_DATETIME" class="<?php echo $config_union_add->LeftColumnClass ?>"><?php echo $config_union->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_union_add->RightColumnClass ?>"><div<?php echo $config_union->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_union_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_union_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_union_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_unionadd.Init();
</script>
<?php
$config_union_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_union_add->Page_Terminate();
?>

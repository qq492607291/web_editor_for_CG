...
$equip_combined_edit = NULL; // Initialize page object first

class cequip_combined_edit extends cequip_combined {
	...
	// Page object name
	var $PageObjName = 'equip_combined_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// SuitName
			$this->SuitName->SetDbValueDef($rsnew, $this->SuitName->CurrentValue, "", $this->SuitName->ReadOnly);
...
// Create page object
if (!isset($equip_combined_edit)) $equip_combined_edit = new cequip_combined_edit();

// Page init
$equip_combined_edit->Page_Init();

// Page main
$equip_combined_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$equip_combined_edit->Page_Render();
?>
...
var CurrentForm = fequip_combinededit = new ew_Form("fequip_combinededit", "edit");

// Validate form
fequip_combinededit.Validate = function() {
...
fequip_combinededit.Form_CustomValidate = 
...
fequip_combinededit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $equip_combined_edit->ShowPageHeader(); ?>
<?php
$equip_combined_edit->ShowMessage();
?>
<form name="fequip_combinededit" id="fequip_combinededit" class="<?php echo $equip_combined_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($equip_combined_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $equip_combined_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="equip_combined">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($equip_combined_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($equip_combined->unid->Visible) { // unid ?>
	<div id="r_unid" class="form-group">
		<label id="elh_equip_combined_unid" class="<?php echo $equip_combined_edit->LeftColumnClass ?>"><?php echo $equip_combined->unid->FldCaption() ?></label>
		<div class="<?php echo $equip_combined_edit->RightColumnClass ?>"><div<?php echo $equip_combined->unid->CellAttributes() ?>>
<span id="el_equip_combined_unid">
<span<?php echo $equip_combined->unid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $equip_combined->unid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="equip_combined" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($equip_combined->unid->CurrentValue) ?>">
<?php echo $equip_combined->unid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($equip_combined->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_equip_combined_u_id" for="x_u_id" class="<?php echo $equip_combined_edit->LeftColumnClass ?>"><?php echo $equip_combined->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_combined_edit->RightColumnClass ?>"><div<?php echo $equip_combined->u_id->CellAttributes() ?>>
...
<?php if ($equip_combined->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_equip_combined_acl_id" for="x_acl_id" class="<?php echo $equip_combined_edit->LeftColumnClass ?>"><?php echo $equip_combined->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_combined_edit->RightColumnClass ?>"><div<?php echo $equip_combined->acl_id->CellAttributes() ?>>
...
<?php if ($equip_combined->SuitName->Visible) { // SuitName ?>
	<div id="r_SuitName" class="form-group">
		<label id="elh_equip_combined_SuitName" for="x_SuitName" class="<?php echo $equip_combined_edit->LeftColumnClass ?>"><?php echo $equip_combined->SuitName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_combined_edit->RightColumnClass ?>"><div<?php echo $equip_combined->SuitName->CellAttributes() ?>>
...
<?php if ($equip_combined->EquipName->Visible) { // EquipName ?>
	<div id="r_EquipName" class="form-group">
		<label id="elh_equip_combined_EquipName" for="x_EquipName" class="<?php echo $equip_combined_edit->LeftColumnClass ?>"><?php echo $equip_combined->EquipName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_combined_edit->RightColumnClass ?>"><div<?php echo $equip_combined->EquipName->CellAttributes() ?>>
...
<?php if ($equip_combined->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_equip_combined_DATETIME" for="x_DATETIME" class="<?php echo $equip_combined_edit->LeftColumnClass ?>"><?php echo $equip_combined->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $equip_combined_edit->RightColumnClass ?>"><div<?php echo $equip_combined->DATETIME->CellAttributes() ?>>
...
<?php if (!$equip_combined_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $equip_combined_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $equip_combined_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fequip_combinededit.Init();
</script>
<?php
$equip_combined_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$equip_combined_edit->Page_Terminate();
?>

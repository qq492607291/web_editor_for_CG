...
$ext_collection_function = NULL;

//
// Table class for ext_collection_function
//
class cext_collection_function extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_collection_function';
		$this->TableName = 'ext_collection_function';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_collection_function`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_collection_function', 'ext_collection_function', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_collection_function', 'ext_collection_function', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_collection_function', 'ext_collection_function', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('ext_collection_function', 'ext_collection_function', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// Trigger
		$this->Trigger = new cField('ext_collection_function', 'ext_collection_function', 'x_Trigger', 'Trigger', '`Trigger`', '`Trigger`', 201, -1, FALSE, '`Trigger`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Trigger->Sortable = TRUE; // Allow sort
		$this->fields['Trigger'] = &$this->Trigger;

		// TR_Limit
		$this->TR_Limit = new cField('ext_collection_function', 'ext_collection_function', 'x_TR_Limit', 'TR_Limit', '`TR_Limit`', '`TR_Limit`', 201, -1, FALSE, '`TR_Limit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->TR_Limit->Sortable = TRUE; // Allow sort
		$this->fields['TR_Limit'] = &$this->TR_Limit;

		// Function
		$this->Function = new cField('ext_collection_function', 'ext_collection_function', 'x_Function', 'Function', '`Function`', '`Function`', 201, -1, FALSE, '`Function`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Function->Sortable = TRUE; // Allow sort
		$this->fields['Function'] = &$this->Function;

		// DATETIME
		$this->DATETIME = new cField('ext_collection_function', 'ext_collection_function', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_collection_function`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ext_collection_functionlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_collection_functionedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_collection_functionadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_collection_functionview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_collection_functionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_collection_functionadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_collection_functionadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_collection_functionedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_collection_functionadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_collection_functiondelete.php", $this->UrlParm());
	}

...
$equip_register_view = NULL; // Initialize page object first

class cequip_register_view extends cequip_register {
	...
	// Page object name
	var $PageObjName = 'equip_register_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["unid"] <> "") {
				...
				$sReturnUrl = "equip_registerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "equip_registerlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "equip_registerlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($equip_register_view)) $equip_register_view = new cequip_register_view();

// Page init
$equip_register_view->Page_Init();

// Page main
$equip_register_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$equip_register_view->Page_Render();
?>
...
var CurrentForm = fequip_registerview = new ew_Form("fequip_registerview", "view");

// Form_CustomValidate event
fequip_registerview.Form_CustomValidate = 
...
fequip_registerview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $equip_register_view->ExportOptions->Render("body") ?>
<?php
	foreach ($equip_register_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $equip_register_view->ShowPageHeader(); ?>
<?php
$equip_register_view->ShowMessage();
?>
<form name="fequip_registerview" id="fequip_registerview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($equip_register_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $equip_register_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="equip_register">
<input type="hidden" name="modal" value="<?php echo intval($equip_register_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($equip_register->unid->Visible) { // unid ?>
	<tr id="r_unid">
		<td class="col-sm-2"><span id="elh_equip_register_unid"><?php echo $equip_register->unid->FldCaption() ?></span></td>
...
<?php echo $equip_register->unid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->u_id->Visible) { // u_id ?>
	<tr id="r_u_id">
		<td class="col-sm-2"><span id="elh_equip_register_u_id"><?php echo $equip_register->u_id->FldCaption() ?></span></td>
...
<?php echo $equip_register->u_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->acl_id->Visible) { // acl_id ?>
	<tr id="r_acl_id">
		<td class="col-sm-2"><span id="elh_equip_register_acl_id"><?php echo $equip_register->acl_id->FldCaption() ?></span></td>
...
<?php echo $equip_register->acl_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->User->Visible) { // User ?>
	<tr id="r_User">
		<td class="col-sm-2"><span id="elh_equip_register_User"><?php echo $equip_register->User->FldCaption() ?></span></td>
		<td data-name="User"<?php echo $equip_register->User->CellAttributes() ?>>
<span id="el_equip_register_User">
<span<?php echo $equip_register->User->ViewAttributes() ?>>
<?php echo $equip_register->User->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->SlotName->Visible) { // SlotName ?>
	<tr id="r_SlotName">
		<td class="col-sm-2"><span id="elh_equip_register_SlotName"><?php echo $equip_register->SlotName->FldCaption() ?></span></td>
		<td data-name="SlotName"<?php echo $equip_register->SlotName->CellAttributes() ?>>
<span id="el_equip_register_SlotName">
<span<?php echo $equip_register->SlotName->ViewAttributes() ?>>
<?php echo $equip_register->SlotName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->EquipName->Visible) { // EquipName ?>
	<tr id="r_EquipName">
		<td class="col-sm-2"><span id="elh_equip_register_EquipName"><?php echo $equip_register->EquipName->FldCaption() ?></span></td>
		<td data-name="EquipName"<?php echo $equip_register->EquipName->CellAttributes() ?>>
<span id="el_equip_register_EquipName">
<span<?php echo $equip_register->EquipName->ViewAttributes() ?>>
<?php echo $equip_register->EquipName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_HP->Visible) { // Add_HP ?>
	<tr id="r_Add_HP">
		<td class="col-sm-2"><span id="elh_equip_register_Add_HP"><?php echo $equip_register->Add_HP->FldCaption() ?></span></td>
		<td data-name="Add_HP"<?php echo $equip_register->Add_HP->CellAttributes() ?>>
<span id="el_equip_register_Add_HP">
<span<?php echo $equip_register->Add_HP->ViewAttributes() ?>>
<?php echo $equip_register->Add_HP->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_MP->Visible) { // Add_MP ?>
	<tr id="r_Add_MP">
		<td class="col-sm-2"><span id="elh_equip_register_Add_MP"><?php echo $equip_register->Add_MP->FldCaption() ?></span></td>
		<td data-name="Add_MP"<?php echo $equip_register->Add_MP->CellAttributes() ?>>
<span id="el_equip_register_Add_MP">
<span<?php echo $equip_register->Add_MP->ViewAttributes() ?>>
<?php echo $equip_register->Add_MP->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_Defense->Visible) { // Add_Defense ?>
	<tr id="r_Add_Defense">
		<td class="col-sm-2"><span id="elh_equip_register_Add_Defense"><?php echo $equip_register->Add_Defense->FldCaption() ?></span></td>
		<td data-name="Add_Defense"<?php echo $equip_register->Add_Defense->CellAttributes() ?>>
<span id="el_equip_register_Add_Defense">
<span<?php echo $equip_register->Add_Defense->ViewAttributes() ?>>
<?php echo $equip_register->Add_Defense->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_Magic->Visible) { // Add_Magic ?>
	<tr id="r_Add_Magic">
		<td class="col-sm-2"><span id="elh_equip_register_Add_Magic"><?php echo $equip_register->Add_Magic->FldCaption() ?></span></td>
		<td data-name="Add_Magic"<?php echo $equip_register->Add_Magic->CellAttributes() ?>>
<span id="el_equip_register_Add_Magic">
<span<?php echo $equip_register->Add_Magic->ViewAttributes() ?>>
<?php echo $equip_register->Add_Magic->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_AD->Visible) { // Add_AD ?>
	<tr id="r_Add_AD">
		<td class="col-sm-2"><span id="elh_equip_register_Add_AD"><?php echo $equip_register->Add_AD->FldCaption() ?></span></td>
		<td data-name="Add_AD"<?php echo $equip_register->Add_AD->CellAttributes() ?>>
<span id="el_equip_register_Add_AD">
<span<?php echo $equip_register->Add_AD->ViewAttributes() ?>>
<?php echo $equip_register->Add_AD->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_AP->Visible) { // Add_AP ?>
	<tr id="r_Add_AP">
		<td class="col-sm-2"><span id="elh_equip_register_Add_AP"><?php echo $equip_register->Add_AP->FldCaption() ?></span></td>
		<td data-name="Add_AP"<?php echo $equip_register->Add_AP->CellAttributes() ?>>
<span id="el_equip_register_Add_AP">
<span<?php echo $equip_register->Add_AP->ViewAttributes() ?>>
<?php echo $equip_register->Add_AP->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_Hit->Visible) { // Add_Hit ?>
	<tr id="r_Add_Hit">
		<td class="col-sm-2"><span id="elh_equip_register_Add_Hit"><?php echo $equip_register->Add_Hit->FldCaption() ?></span></td>
		<td data-name="Add_Hit"<?php echo $equip_register->Add_Hit->CellAttributes() ?>>
<span id="el_equip_register_Add_Hit">
<span<?php echo $equip_register->Add_Hit->ViewAttributes() ?>>
<?php echo $equip_register->Add_Hit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_Dodge->Visible) { // Add_Dodge ?>
	<tr id="r_Add_Dodge">
		<td class="col-sm-2"><span id="elh_equip_register_Add_Dodge"><?php echo $equip_register->Add_Dodge->FldCaption() ?></span></td>
		<td data-name="Add_Dodge"<?php echo $equip_register->Add_Dodge->CellAttributes() ?>>
<span id="el_equip_register_Add_Dodge">
<span<?php echo $equip_register->Add_Dodge->ViewAttributes() ?>>
<?php echo $equip_register->Add_Dodge->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_Crit->Visible) { // Add_Crit ?>
	<tr id="r_Add_Crit">
		<td class="col-sm-2"><span id="elh_equip_register_Add_Crit"><?php echo $equip_register->Add_Crit->FldCaption() ?></span></td>
		<td data-name="Add_Crit"<?php echo $equip_register->Add_Crit->CellAttributes() ?>>
<span id="el_equip_register_Add_Crit">
<span<?php echo $equip_register->Add_Crit->ViewAttributes() ?>>
<?php echo $equip_register->Add_Crit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_AbsorbHP->Visible) { // Add_AbsorbHP ?>
	<tr id="r_Add_AbsorbHP">
		<td class="col-sm-2"><span id="elh_equip_register_Add_AbsorbHP"><?php echo $equip_register->Add_AbsorbHP->FldCaption() ?></span></td>
		<td data-name="Add_AbsorbHP"<?php echo $equip_register->Add_AbsorbHP->CellAttributes() ?>>
<span id="el_equip_register_Add_AbsorbHP">
<span<?php echo $equip_register->Add_AbsorbHP->ViewAttributes() ?>>
<?php echo $equip_register->Add_AbsorbHP->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_ADPTV->Visible) { // Add_ADPTV ?>
	<tr id="r_Add_ADPTV">
		<td class="col-sm-2"><span id="elh_equip_register_Add_ADPTV"><?php echo $equip_register->Add_ADPTV->FldCaption() ?></span></td>
		<td data-name="Add_ADPTV"<?php echo $equip_register->Add_ADPTV->CellAttributes() ?>>
<span id="el_equip_register_Add_ADPTV">
<span<?php echo $equip_register->Add_ADPTV->ViewAttributes() ?>>
<?php echo $equip_register->Add_ADPTV->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_ADPTR->Visible) { // Add_ADPTR ?>
	<tr id="r_Add_ADPTR">
		<td class="col-sm-2"><span id="elh_equip_register_Add_ADPTR"><?php echo $equip_register->Add_ADPTR->FldCaption() ?></span></td>
		<td data-name="Add_ADPTR"<?php echo $equip_register->Add_ADPTR->CellAttributes() ?>>
<span id="el_equip_register_Add_ADPTR">
<span<?php echo $equip_register->Add_ADPTR->ViewAttributes() ?>>
<?php echo $equip_register->Add_ADPTR->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_APPTR->Visible) { // Add_APPTR ?>
	<tr id="r_Add_APPTR">
		<td class="col-sm-2"><span id="elh_equip_register_Add_APPTR"><?php echo $equip_register->Add_APPTR->FldCaption() ?></span></td>
		<td data-name="Add_APPTR"<?php echo $equip_register->Add_APPTR->CellAttributes() ?>>
<span id="el_equip_register_Add_APPTR">
<span<?php echo $equip_register->Add_APPTR->ViewAttributes() ?>>
<?php echo $equip_register->Add_APPTR->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_APPTV->Visible) { // Add_APPTV ?>
	<tr id="r_Add_APPTV">
		<td class="col-sm-2"><span id="elh_equip_register_Add_APPTV"><?php echo $equip_register->Add_APPTV->FldCaption() ?></span></td>
		<td data-name="Add_APPTV"<?php echo $equip_register->Add_APPTV->CellAttributes() ?>>
<span id="el_equip_register_Add_APPTV">
<span<?php echo $equip_register->Add_APPTV->ViewAttributes() ?>>
<?php echo $equip_register->Add_APPTV->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Add_ImmuneDamage->Visible) { // Add_ImmuneDamage ?>
	<tr id="r_Add_ImmuneDamage">
		<td class="col-sm-2"><span id="elh_equip_register_Add_ImmuneDamage"><?php echo $equip_register->Add_ImmuneDamage->FldCaption() ?></span></td>
		<td data-name="Add_ImmuneDamage"<?php echo $equip_register->Add_ImmuneDamage->CellAttributes() ?>>
<span id="el_equip_register_Add_ImmuneDamage">
<span<?php echo $equip_register->Add_ImmuneDamage->ViewAttributes() ?>>
<?php echo $equip_register->Add_ImmuneDamage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Special_Type->Visible) { // Special_Type ?>
	<tr id="r_Special_Type">
		<td class="col-sm-2"><span id="elh_equip_register_Special_Type"><?php echo $equip_register->Special_Type->FldCaption() ?></span></td>
		<td data-name="Special_Type"<?php echo $equip_register->Special_Type->CellAttributes() ?>>
<span id="el_equip_register_Special_Type">
<span<?php echo $equip_register->Special_Type->ViewAttributes() ?>>
<?php echo $equip_register->Special_Type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->Special_Value->Visible) { // Special_Value ?>
	<tr id="r_Special_Value">
		<td class="col-sm-2"><span id="elh_equip_register_Special_Value"><?php echo $equip_register->Special_Value->FldCaption() ?></span></td>
		<td data-name="Special_Value"<?php echo $equip_register->Special_Value->CellAttributes() ?>>
<span id="el_equip_register_Special_Value">
<span<?php echo $equip_register->Special_Value->ViewAttributes() ?>>
<?php echo $equip_register->Special_Value->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equip_register->DATETIME->Visible) { // DATETIME ?>
	<tr id="r_DATETIME">
		<td class="col-sm-2"><span id="elh_equip_register_DATETIME"><?php echo $equip_register->DATETIME->FldCaption() ?></span></td>
...
<?php echo $equip_register->DATETIME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fequip_registerview.Init();
</script>
<?php
$equip_register_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$equip_register_view->Page_Terminate();
?>

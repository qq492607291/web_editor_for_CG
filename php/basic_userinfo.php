...
//
// Table class for basic_user
//
class cbasic_user extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $ID;
	...
	function __construct() {
		...
		$this->TableVar = 'basic_user';
		$this->TableName = 'basic_user';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`basic_user`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('basic_user', 'basic_user', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('basic_user', 'basic_user', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('basic_user', 'basic_user', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID
		$this->ID = new cField('basic_user', 'basic_user', 'x_ID', 'ID', '`ID`', '`ID`', 201, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ID->Sortable = TRUE; // Allow sort
		$this->fields['ID'] = &$this->ID;

		// Node
		$this->Node = new cField('basic_user', 'basic_user', 'x_Node', 'Node', '`Node`', '`Node`', 201, -1, FALSE, '`Node`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Node->Sortable = TRUE; // Allow sort
		$this->fields['Node'] = &$this->Node;

		// Item
		$this->Item = new cField('basic_user', 'basic_user', 'x_Item', 'Item', '`Item`', '`Item`', 201, -1, FALSE, '`Item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Item->Sortable = TRUE; // Allow sort
		$this->fields['Item'] = &$this->Item;

		// Data
		$this->Data = new cField('basic_user', 'basic_user', 'x_Data', 'Data', '`Data`', '`Data`', 201, -1, FALSE, '`Data`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Data->Sortable = TRUE; // Allow sort
		$this->fields['Data'] = &$this->Data;

		// DATETIME
		$this->DATETIME = new cField('basic_user', 'basic_user', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`basic_user`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "basic_useredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "basic_useradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("basic_userview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("basic_userview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "basic_useradd.php?" . $this->UrlParm($parm);
		else
			$url = "basic_useradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("basic_useredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("basic_useradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("basic_userdelete.php", $this->UrlParm());
	}

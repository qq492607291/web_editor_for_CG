...
$ext_shdic_log_add = NULL; // Initialize page object first

class cext_shdic_log_add extends cext_shdic_log {
	...
	// Page object name
	var $PageObjName = 'ext_shdic_log_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ext_shdic_logview.php")
...
// Create page object
if (!isset($ext_shdic_log_add)) $ext_shdic_log_add = new cext_shdic_log_add();

// Page init
$ext_shdic_log_add->Page_Init();

// Page main
$ext_shdic_log_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_shdic_log_add->Page_Render();
?>
...
var CurrentForm = fext_shdic_logadd = new ew_Form("fext_shdic_logadd", "add");

// Validate form
fext_shdic_logadd.Validate = function() {
...
fext_shdic_logadd.Form_CustomValidate = 
...
fext_shdic_logadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_shdic_log_add->ShowPageHeader(); ?>
<?php
$ext_shdic_log_add->ShowMessage();
?>
<form name="fext_shdic_logadd" id="fext_shdic_logadd" class="<?php echo $ext_shdic_log_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_shdic_log_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_shdic_log_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_shdic_log">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($ext_shdic_log_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($ext_shdic_log->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_shdic_log_u_id" for="x_u_id" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->u_id->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_shdic_log_acl_id" for="x_acl_id" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->acl_id->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->ExtId->Visible) { // ExtId ?>
	<div id="r_ExtId" class="form-group">
		<label id="elh_ext_shdic_log_ExtId" for="x_ExtId" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->ExtId->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->ExtId->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->ExtType->Visible) { // ExtType ?>
	<div id="r_ExtType" class="form-group">
		<label id="elh_ext_shdic_log_ExtType" for="x_ExtType" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->ExtType->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->ExtType->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_ext_shdic_log_Name" for="x_Name" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->Name->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->C->Visible) { // C ?>
	<div id="r_C" class="form-group">
		<label id="elh_ext_shdic_log_C" for="x_C" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->C->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->C->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->K->Visible) { // K ?>
	<div id="r_K" class="form-group">
		<label id="elh_ext_shdic_log_K" for="x_K" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->K->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->K->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->V->Visible) { // V ?>
	<div id="r_V" class="form-group">
		<label id="elh_ext_shdic_log_V" for="x_V" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->V->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->V->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->Trigger->Visible) { // Trigger ?>
	<div id="r_Trigger" class="form-group">
		<label id="elh_ext_shdic_log_Trigger" for="x_Trigger" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->Trigger->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->Trigger->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->TR_Limit->Visible) { // TR_Limit ?>
	<div id="r_TR_Limit" class="form-group">
		<label id="elh_ext_shdic_log_TR_Limit" for="x_TR_Limit" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->TR_Limit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->TR_Limit->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->Function->Visible) { // Function ?>
	<div id="r_Function" class="form-group">
		<label id="elh_ext_shdic_log_Function" for="x_Function" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->Function->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->Function->CellAttributes() ?>>
...
<?php if ($ext_shdic_log->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_shdic_log_DATETIME" for="x_DATETIME" class="<?php echo $ext_shdic_log_add->LeftColumnClass ?>"><?php echo $ext_shdic_log->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_shdic_log_add->RightColumnClass ?>"><div<?php echo $ext_shdic_log->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_shdic_log_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_shdic_log_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_shdic_log_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_shdic_logadd.Init();
</script>
<?php
$ext_shdic_log_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_shdic_log_add->Page_Terminate();
?>

...
//
// Table class for ext_awake_info
//
class cext_awake_info extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $title_______UNIQUE;
	var $baseTitle;
	var $isEnable;
	var $needGold;
	var $needDiam;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_awake_info';
		$this->TableName = 'ext_awake_info';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_awake_info`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_awake_info', 'ext_awake_info', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_awake_info', 'ext_awake_info', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_awake_info', 'ext_awake_info', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// title       UNIQUE
		$this->title_______UNIQUE = new cField('ext_awake_info', 'ext_awake_info', 'x_title_______UNIQUE', 'title       UNIQUE', '`title       UNIQUE`', '`title       UNIQUE`', 201, -1, FALSE, '`title       UNIQUE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->title_______UNIQUE->Sortable = TRUE; // Allow sort
		$this->fields['title       UNIQUE'] = &$this->title_______UNIQUE;

		// baseTitle
		$this->baseTitle = new cField('ext_awake_info', 'ext_awake_info', 'x_baseTitle', 'baseTitle', '`baseTitle`', '`baseTitle`', 201, -1, FALSE, '`baseTitle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->baseTitle->Sortable = TRUE; // Allow sort
		$this->fields['baseTitle'] = &$this->baseTitle;

		// isEnable
		$this->isEnable = new cField('ext_awake_info', 'ext_awake_info', 'x_isEnable', 'isEnable', '`isEnable`', '`isEnable`', 201, -1, FALSE, '`isEnable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->isEnable->Sortable = TRUE; // Allow sort
		$this->fields['isEnable'] = &$this->isEnable;

		// needGold
		$this->needGold = new cField('ext_awake_info', 'ext_awake_info', 'x_needGold', 'needGold', '`needGold`', '`needGold`', 201, -1, FALSE, '`needGold`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->needGold->Sortable = TRUE; // Allow sort
		$this->fields['needGold'] = &$this->needGold;

		// needDiam
		$this->needDiam = new cField('ext_awake_info', 'ext_awake_info', 'x_needDiam', 'needDiam', '`needDiam`', '`needDiam`', 201, -1, FALSE, '`needDiam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->needDiam->Sortable = TRUE; // Allow sort
		$this->fields['needDiam'] = &$this->needDiam;

		// needItem
		$this->needItem = new cField('ext_awake_info', 'ext_awake_info', 'x_needItem', 'needItem', '`needItem`', '`needItem`', 201, -1, FALSE, '`needItem`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->needItem->Sortable = TRUE; // Allow sort
		$this->fields['needItem'] = &$this->needItem;

		// DATETIME
		$this->DATETIME = new cField('ext_awake_info', 'ext_awake_info', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_awake_info`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_awake_infoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_awake_infoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_awake_infoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_awake_infoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_awake_infoadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_awake_infoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_awake_infoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_awake_infoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_awake_infodelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->title_______UNIQUE->setDbValue($rs->fields('title       UNIQUE'));
		$this->baseTitle->setDbValue($rs->fields('baseTitle'));
		$this->isEnable->setDbValue($rs->fields('isEnable'));
		$this->needGold->setDbValue($rs->fields('needGold'));
		$this->needDiam->setDbValue($rs->fields('needDiam'));
		$this->needItem->setDbValue($rs->fields('needItem'));
	...
	function RenderEditRow() {
		...
		$this->title_______UNIQUE->EditValue = $this->title_______UNIQUE->CurrentValue;
		...
		$this->baseTitle->EditValue = $this->baseTitle->CurrentValue;
		...
		$this->isEnable->EditValue = $this->isEnable->CurrentValue;
		...
		$this->needGold->EditValue = $this->needGold->CurrentValue;
		...
		$this->needDiam->EditValue = $this->needDiam->CurrentValue;
		...
		$this->needItem->EditValue = $this->needItem->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->title_______UNIQUE->Exportable) $Doc->ExportCaption($this->title_______UNIQUE);
					if ($this->baseTitle->Exportable) $Doc->ExportCaption($this->baseTitle);
					if ($this->isEnable->Exportable) $Doc->ExportCaption($this->isEnable);
					if ($this->needGold->Exportable) $Doc->ExportCaption($this->needGold);
					if ($this->needDiam->Exportable) $Doc->ExportCaption($this->needDiam);
					if ($this->needItem->Exportable) $Doc->ExportCaption($this->needItem);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->title_______UNIQUE->Exportable) $Doc->ExportField($this->title_______UNIQUE);
						if ($this->baseTitle->Exportable) $Doc->ExportField($this->baseTitle);
						if ($this->isEnable->Exportable) $Doc->ExportField($this->isEnable);
						if ($this->needGold->Exportable) $Doc->ExportField($this->needGold);
						if ($this->needDiam->Exportable) $Doc->ExportField($this->needDiam);
						if ($this->needItem->Exportable) $Doc->ExportField($this->needItem);

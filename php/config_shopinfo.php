...
//
// Table class for config_shop
//
class cconfig_shop extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'config_shop';
		$this->TableName = 'config_shop';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`config_shop`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('config_shop', 'config_shop', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('config_shop', 'config_shop', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('config_shop', 'config_shop', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('config_shop', 'config_shop', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// Currency
		$this->Currency = new cField('config_shop', 'config_shop', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 201, -1, FALSE, '`Currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Currency->Sortable = TRUE; // Allow sort
		$this->fields['Currency'] = &$this->Currency;

		// Price
		$this->Price = new cField('config_shop', 'config_shop', 'x_Price', 'Price', '`Price`', '`Price`', 201, -1, FALSE, '`Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Price->Sortable = TRUE; // Allow sort
		$this->fields['Price'] = &$this->Price;

		// LimitNumber
		$this->LimitNumber = new cField('config_shop', 'config_shop', 'x_LimitNumber', 'LimitNumber', '`LimitNumber`', '`LimitNumber`', 201, -1, FALSE, '`LimitNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LimitNumber->Sortable = TRUE; // Allow sort
		$this->fields['LimitNumber'] = &$this->LimitNumber;

		// LimitType
		$this->LimitType = new cField('config_shop', 'config_shop', 'x_LimitType', 'LimitType', '`LimitType`', '`LimitType`', 201, -1, FALSE, '`LimitType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LimitType->Sortable = TRUE; // Allow sort
		$this->fields['LimitType'] = &$this->LimitType;

		// DATETIME
		$this->DATETIME = new cField('config_shop', 'config_shop', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`config_shop`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "config_shopedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "config_shopadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("config_shopview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("config_shopview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "config_shopadd.php?" . $this->UrlParm($parm);
		else
			$url = "config_shopadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("config_shopedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("config_shopadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("config_shopdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->LimitNumber->setDbValue($rs->fields('LimitNumber'));
		$this->LimitType->setDbValue($rs->fields('LimitType'));
	...
	function RenderEditRow() {
		...
		$this->LimitNumber->EditValue = $this->LimitNumber->CurrentValue;
		...
		$this->LimitType->EditValue = $this->LimitType->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->LimitNumber->Exportable) $Doc->ExportCaption($this->LimitNumber);
					if ($this->LimitType->Exportable) $Doc->ExportCaption($this->LimitType);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->LimitNumber->Exportable) $Doc->ExportField($this->LimitNumber);
						if ($this->LimitType->Exportable) $Doc->ExportField($this->LimitType);

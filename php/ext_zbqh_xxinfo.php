...
//
// Table class for ext_zbqh_xx
//
class cext_zbqh_xx extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_zbqh_xx';
		$this->TableName = 'ext_zbqh_xx';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_zbqh_xx`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// LV
		$this->LV = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_LV', 'LV', '`LV`', '`LV`', 201, -1, FALSE, '`LV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LV->Sortable = TRUE; // Allow sort
		$this->fields['LV'] = &$this->LV;

		// XHJB
		$this->XHJB = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_XHJB', 'XHJB', '`XHJB`', '`XHJB`', 201, -1, FALSE, '`XHJB`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->XHJB->Sortable = TRUE; // Allow sort
		$this->fields['XHJB'] = &$this->XHJB;

		// XHZS
		$this->XHZS = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_XHZS', 'XHZS', '`XHZS`', '`XHZS`', 201, -1, FALSE, '`XHZS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->XHZS->Sortable = TRUE; // Allow sort
		$this->fields['XHZS'] = &$this->XHZS;

		// XHWP
		$this->XHWP = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_XHWP', 'XHWP', '`XHWP`', '`XHWP`', 201, -1, FALSE, '`XHWP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->XHWP->Sortable = TRUE; // Allow sort
		$this->fields['XHWP'] = &$this->XHWP;

		// ADDSX
		$this->ADDSX = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_ADDSX', 'ADDSX', '`ADDSX`', '`ADDSX`', 201, -1, FALSE, '`ADDSX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ADDSX->Sortable = TRUE; // Allow sort
		$this->fields['ADDSX'] = &$this->ADDSX;

		// SuccessV
		$this->SuccessV = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_SuccessV', 'SuccessV', '`SuccessV`', '`SuccessV`', 201, -1, FALSE, '`SuccessV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->SuccessV->Sortable = TRUE; // Allow sort
		$this->fields['SuccessV'] = &$this->SuccessV;

		// DATETIME
		$this->DATETIME = new cField('ext_zbqh_xx', 'ext_zbqh_xx', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_zbqh_xx`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_zbqh_xxedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_zbqh_xxadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_zbqh_xxview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_zbqh_xxview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_zbqh_xxadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_zbqh_xxadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_zbqh_xxedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_zbqh_xxadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_zbqh_xxdelete.php", $this->UrlParm());
	}

...
//
// Table class for ext_zbqh_dj
//
class cext_zbqh_dj extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_zbqh_dj';
		$this->TableName = 'ext_zbqh_dj';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_zbqh_dj`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// QName
		$this->QName = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_QName', 'QName', '`QName`', '`QName`', 201, -1, FALSE, '`QName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->QName->Sortable = TRUE; // Allow sort
		$this->fields['QName'] = &$this->QName;

		// LV
		$this->LV = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_LV', 'LV', '`LV`', '`LV`', 201, -1, FALSE, '`LV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LV->Sortable = TRUE; // Allow sort
		$this->fields['LV'] = &$this->LV;

		// DATETIME
		$this->DATETIME = new cField('ext_zbqh_dj', 'ext_zbqh_dj', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_zbqh_dj`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_zbqh_djedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_zbqh_djadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_zbqh_djview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_zbqh_djview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_zbqh_djadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_zbqh_djadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_zbqh_djedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_zbqh_djadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_zbqh_djdelete.php", $this->UrlParm());
	}

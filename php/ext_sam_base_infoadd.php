...
$ext_sam_base_info_add = NULL; // Initialize page object first

class cext_sam_base_info_add extends cext_sam_base_info {
	...
	// Page object name
	var $PageObjName = 'ext_sam_base_info_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ext_sam_base_infoview.php")
...
// Create page object
if (!isset($ext_sam_base_info_add)) $ext_sam_base_info_add = new cext_sam_base_info_add();

// Page init
$ext_sam_base_info_add->Page_Init();

// Page main
$ext_sam_base_info_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_sam_base_info_add->Page_Render();
?>
...
var CurrentForm = fext_sam_base_infoadd = new ew_Form("fext_sam_base_infoadd", "add");

// Validate form
fext_sam_base_infoadd.Validate = function() {
...
fext_sam_base_infoadd.Form_CustomValidate = 
...
fext_sam_base_infoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_sam_base_info_add->ShowPageHeader(); ?>
<?php
$ext_sam_base_info_add->ShowMessage();
?>
<form name="fext_sam_base_infoadd" id="fext_sam_base_infoadd" class="<?php echo $ext_sam_base_info_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_sam_base_info_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_sam_base_info_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_sam_base_info">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($ext_sam_base_info_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($ext_sam_base_info->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_sam_base_info_u_id" for="x_u_id" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->u_id->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_sam_base_info_acl_id" for="x_acl_id" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->acl_id->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_ext_sam_base_info_Name" for="x_Name" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->Name->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->LV->Visible) { // LV ?>
	<div id="r_LV" class="form-group">
		<label id="elh_ext_sam_base_info_LV" for="x_LV" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->LV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->LV->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->MainCat->Visible) { // MainCat ?>
	<div id="r_MainCat" class="form-group">
		<label id="elh_ext_sam_base_info_MainCat" for="x_MainCat" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->MainCat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->MainCat->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->SubCat->Visible) { // SubCat ?>
	<div id="r_SubCat" class="form-group">
		<label id="elh_ext_sam_base_info_SubCat" for="x_SubCat" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->SubCat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->SubCat->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->Location->Visible) { // Location ?>
	<div id="r_Location" class="form-group">
		<label id="elh_ext_sam_base_info_Location" for="x_Location" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->Location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->Location->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->Dialog->Visible) { // Dialog ?>
	<div id="r_Dialog" class="form-group">
		<label id="elh_ext_sam_base_info_Dialog" for="x_Dialog" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->Dialog->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->Dialog->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->Function->Visible) { // Function ?>
	<div id="r_Function" class="form-group">
		<label id="elh_ext_sam_base_info_Function" for="x_Function" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->Function->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->Function->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->Introduce->Visible) { // Introduce ?>
	<div id="r_Introduce" class="form-group">
		<label id="elh_ext_sam_base_info_Introduce" for="x_Introduce" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->Introduce->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->Introduce->CellAttributes() ?>>
...
<?php if ($ext_sam_base_info->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_sam_base_info_DATETIME" for="x_DATETIME" class="<?php echo $ext_sam_base_info_add->LeftColumnClass ?>"><?php echo $ext_sam_base_info->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_sam_base_info_add->RightColumnClass ?>"><div<?php echo $ext_sam_base_info->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_sam_base_info_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_sam_base_info_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_sam_base_info_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_sam_base_infoadd.Init();
</script>
<?php
$ext_sam_base_info_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_sam_base_info_add->Page_Terminate();
?>

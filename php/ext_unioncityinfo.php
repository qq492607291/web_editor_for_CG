...
//
// Table class for ext_unioncity
//
class cext_unioncity extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_unioncity';
		$this->TableName = 'ext_unioncity';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_unioncity`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_unioncity', 'ext_unioncity', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_unioncity', 'ext_unioncity', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_unioncity', 'ext_unioncity', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('ext_unioncity', 'ext_unioncity', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// Location
		$this->Location = new cField('ext_unioncity', 'ext_unioncity', 'x_Location', 'Location', '`Location`', '`Location`', 201, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Function
		$this->Function = new cField('ext_unioncity', 'ext_unioncity', 'x_Function', 'Function', '`Function`', '`Function`', 201, -1, FALSE, '`Function`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Function->Sortable = TRUE; // Allow sort
		$this->fields['Function'] = &$this->Function;

		// Dialog
		$this->Dialog = new cField('ext_unioncity', 'ext_unioncity', 'x_Dialog', 'Dialog', '`Dialog`', '`Dialog`', 201, -1, FALSE, '`Dialog`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Dialog->Sortable = TRUE; // Allow sort
		$this->fields['Dialog'] = &$this->Dialog;

		// Introduce
		$this->Introduce = new cField('ext_unioncity', 'ext_unioncity', 'x_Introduce', 'Introduce', '`Introduce`', '`Introduce`', 201, -1, FALSE, '`Introduce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Introduce->Sortable = TRUE; // Allow sort
		$this->fields['Introduce'] = &$this->Introduce;

		// DATETIME
		$this->DATETIME = new cField('ext_unioncity', 'ext_unioncity', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_unioncity`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_unioncityedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_unioncityadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_unioncityview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_unioncityview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_unioncityadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_unioncityadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_unioncityedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_unioncityadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_unioncitydelete.php", $this->UrlParm());
	}

...
$config_goods_edit = NULL; // Initialize page object first

class cconfig_goods_edit extends cconfig_goods {
	...
	// Page object name
	var $PageObjName = 'config_goods_edit';
...
// Create page object
if (!isset($config_goods_edit)) $config_goods_edit = new cconfig_goods_edit();

// Page init
$config_goods_edit->Page_Init();

// Page main
$config_goods_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_goods_edit->Page_Render();
?>
...
var CurrentForm = fconfig_goodsedit = new ew_Form("fconfig_goodsedit", "edit");

// Validate form
fconfig_goodsedit.Validate = function() {
...
fconfig_goodsedit.Form_CustomValidate = 
...
fconfig_goodsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_goods_edit->ShowPageHeader(); ?>
<?php
$config_goods_edit->ShowMessage();
?>
<form name="fconfig_goodsedit" id="fconfig_goodsedit" class="<?php echo $config_goods_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_goods_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_goods_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_goods">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($config_goods_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($config_goods->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_goods_u_id" for="x_u_id" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->u_id->CellAttributes() ?>>
...
<?php if ($config_goods->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_goods_acl_id" for="x_acl_id" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->acl_id->CellAttributes() ?>>
...
<?php if ($config_goods->ID->Visible) { // ID ?>
	<div id="r_ID" class="form-group">
		<label id="elh_config_goods_ID" for="x_ID" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->ID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->ID->CellAttributes() ?>>
...
<?php if ($config_goods->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_config_goods_Name" for="x_Name" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->Name->CellAttributes() ?>>
...
<?php if ($config_goods->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group">
		<label id="elh_config_goods_Type" for="x_Type" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->Type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->Type->CellAttributes() ?>>
...
<?php if ($config_goods->Basic->Visible) { // Basic ?>
	<div id="r_Basic" class="form-group">
		<label id="elh_config_goods_Basic" for="x_Basic" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->Basic->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->Basic->CellAttributes() ?>>
...
<?php if ($config_goods->LtemData->Visible) { // LtemData ?>
	<div id="r_LtemData" class="form-group">
		<label id="elh_config_goods_LtemData" for="x_LtemData" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->LtemData->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->LtemData->CellAttributes() ?>>
...
<?php if ($config_goods->Introduce->Visible) { // Introduce ?>
	<div id="r_Introduce" class="form-group">
		<label id="elh_config_goods_Introduce" for="x_Introduce" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->Introduce->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->Introduce->CellAttributes() ?>>
...
<?php if ($config_goods->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_goods_DATETIME" for="x_DATETIME" class="<?php echo $config_goods_edit->LeftColumnClass ?>"><?php echo $config_goods->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_goods_edit->RightColumnClass ?>"><div<?php echo $config_goods->DATETIME->CellAttributes() ?>>
...
<input type="hidden" data-table="config_goods" data-field="x_unid" name="x_unid" id="x_unid" value="<?php echo ew_HtmlEncode($config_goods->unid->CurrentValue) ?>">
<?php if (!$config_goods_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_goods_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_goods_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_goodsedit.Init();
</script>
<?php
$config_goods_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_goods_edit->Page_Terminate();
?>

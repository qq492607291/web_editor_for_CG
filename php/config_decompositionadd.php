...
$config_decomposition_add = NULL; // Initialize page object first

class cconfig_decomposition_add extends cconfig_decomposition {
	...
	// Page object name
	var $PageObjName = 'config_decomposition_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "config_decompositionview.php")
	...
	function LoadDefaultValues() {
		...
		$this->Goods->CurrentValue = NULL;
		$this->Goods->OldValue = $this->Goods->CurrentValue;
		$this->NeedG->CurrentValue = NULL;
		$this->NeedG->OldValue = $this->NeedG->CurrentValue;
		$this->NeedD->CurrentValue = NULL;
		$this->NeedD->OldValue = $this->NeedD->CurrentValue;
		$this->GetGoods->CurrentValue = NULL;
		$this->GetGoods->OldValue = $this->GetGoods->CurrentValue;
		$this->Success->CurrentValue = NULL;
		$this->Success->OldValue = $this->Success->CurrentValue;
	...
	function NewRow() {
		...
		$row['Goods'] = $this->Goods->CurrentValue;
		$row['NeedG'] = $this->NeedG->CurrentValue;
		$row['NeedD'] = $this->NeedD->CurrentValue;
		$row['GetGoods'] = $this->GetGoods->CurrentValue;
		$row['Success'] = $this->Success->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// Goods
		$this->Goods->SetDbValueDef($rsnew, $this->Goods->CurrentValue, "", FALSE);

		// NeedG
		$this->NeedG->SetDbValueDef($rsnew, $this->NeedG->CurrentValue, "", FALSE);

		// NeedD
		$this->NeedD->SetDbValueDef($rsnew, $this->NeedD->CurrentValue, "", FALSE);

		// GetGoods
		$this->GetGoods->SetDbValueDef($rsnew, $this->GetGoods->CurrentValue, "", FALSE);

		// Success
		$this->Success->SetDbValueDef($rsnew, $this->Success->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($config_decomposition_add)) $config_decomposition_add = new cconfig_decomposition_add();

// Page init
$config_decomposition_add->Page_Init();

// Page main
$config_decomposition_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_decomposition_add->Page_Render();
?>
...
var CurrentForm = fconfig_decompositionadd = new ew_Form("fconfig_decompositionadd", "add");

// Validate form
fconfig_decompositionadd.Validate = function() {
...
fconfig_decompositionadd.Form_CustomValidate = 
...
fconfig_decompositionadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $config_decomposition_add->ShowPageHeader(); ?>
<?php
$config_decomposition_add->ShowMessage();
?>
<form name="fconfig_decompositionadd" id="fconfig_decompositionadd" class="<?php echo $config_decomposition_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_decomposition_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_decomposition_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_decomposition">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($config_decomposition_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($config_decomposition->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_config_decomposition_u_id" for="x_u_id" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->u_id->CellAttributes() ?>>
...
<?php if ($config_decomposition->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_config_decomposition_acl_id" for="x_acl_id" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->acl_id->CellAttributes() ?>>
...
<?php if ($config_decomposition->Goods->Visible) { // Goods ?>
	<div id="r_Goods" class="form-group">
		<label id="elh_config_decomposition_Goods" for="x_Goods" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->Goods->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->Goods->CellAttributes() ?>>
...
<?php if ($config_decomposition->NeedG->Visible) { // NeedG ?>
	<div id="r_NeedG" class="form-group">
		<label id="elh_config_decomposition_NeedG" for="x_NeedG" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->NeedG->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->NeedG->CellAttributes() ?>>
...
<?php if ($config_decomposition->NeedD->Visible) { // NeedD ?>
	<div id="r_NeedD" class="form-group">
		<label id="elh_config_decomposition_NeedD" for="x_NeedD" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->NeedD->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->NeedD->CellAttributes() ?>>
...
<?php if ($config_decomposition->GetGoods->Visible) { // GetGoods ?>
	<div id="r_GetGoods" class="form-group">
		<label id="elh_config_decomposition_GetGoods" for="x_GetGoods" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->GetGoods->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->GetGoods->CellAttributes() ?>>
...
<?php if ($config_decomposition->Success->Visible) { // Success ?>
	<div id="r_Success" class="form-group">
		<label id="elh_config_decomposition_Success" for="x_Success" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->Success->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->Success->CellAttributes() ?>>
...
<?php if ($config_decomposition->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_config_decomposition_DATETIME" for="x_DATETIME" class="<?php echo $config_decomposition_add->LeftColumnClass ?>"><?php echo $config_decomposition->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $config_decomposition_add->RightColumnClass ?>"><div<?php echo $config_decomposition->DATETIME->CellAttributes() ?>>
...
<?php if (!$config_decomposition_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $config_decomposition_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $config_decomposition_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfig_decompositionadd.Init();
</script>
<?php
$config_decomposition_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_decomposition_add->Page_Terminate();
?>

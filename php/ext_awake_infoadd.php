...
$ext_awake_info_add = NULL; // Initialize page object first

class cext_awake_info_add extends cext_awake_info {
	...
	// Page object name
	var $PageObjName = 'ext_awake_info_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ext_awake_infoview.php")
	...
	function LoadDefaultValues() {
		...
		$this->title_______UNIQUE->CurrentValue = NULL;
		$this->title_______UNIQUE->OldValue = $this->title_______UNIQUE->CurrentValue;
		$this->baseTitle->CurrentValue = NULL;
		$this->baseTitle->OldValue = $this->baseTitle->CurrentValue;
		$this->isEnable->CurrentValue = NULL;
		$this->isEnable->OldValue = $this->isEnable->CurrentValue;
		$this->needGold->CurrentValue = NULL;
		$this->needGold->OldValue = $this->needGold->CurrentValue;
		$this->needDiam->CurrentValue = NULL;
		$this->needDiam->OldValue = $this->needDiam->CurrentValue;
		$this->needItem->CurrentValue = NULL;
		$this->needItem->OldValue = $this->needItem->CurrentValue;
	...
	function NewRow() {
		...
		$row['title       UNIQUE'] = $this->title_______UNIQUE->CurrentValue;
		$row['baseTitle'] = $this->baseTitle->CurrentValue;
		$row['isEnable'] = $this->isEnable->CurrentValue;
		$row['needGold'] = $this->needGold->CurrentValue;
		$row['needDiam'] = $this->needDiam->CurrentValue;
		$row['needItem'] = $this->needItem->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// title       UNIQUE
		$this->title_______UNIQUE->SetDbValueDef($rsnew, $this->title_______UNIQUE->CurrentValue, "", FALSE);

		// baseTitle
		$this->baseTitle->SetDbValueDef($rsnew, $this->baseTitle->CurrentValue, "", FALSE);

		// isEnable
		$this->isEnable->SetDbValueDef($rsnew, $this->isEnable->CurrentValue, "", FALSE);

		// needGold
		$this->needGold->SetDbValueDef($rsnew, $this->needGold->CurrentValue, "", FALSE);

		// needDiam
		$this->needDiam->SetDbValueDef($rsnew, $this->needDiam->CurrentValue, "", FALSE);

		// needItem
		$this->needItem->SetDbValueDef($rsnew, $this->needItem->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($ext_awake_info_add)) $ext_awake_info_add = new cext_awake_info_add();

// Page init
$ext_awake_info_add->Page_Init();

// Page main
$ext_awake_info_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_awake_info_add->Page_Render();
?>
...
var CurrentForm = fext_awake_infoadd = new ew_Form("fext_awake_infoadd", "add");

// Validate form
fext_awake_infoadd.Validate = function() {
...
fext_awake_infoadd.Form_CustomValidate = 
...
fext_awake_infoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_awake_info_add->ShowPageHeader(); ?>
<?php
$ext_awake_info_add->ShowMessage();
?>
<form name="fext_awake_infoadd" id="fext_awake_infoadd" class="<?php echo $ext_awake_info_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_awake_info_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_awake_info_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_awake_info">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($ext_awake_info_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($ext_awake_info->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_awake_info_u_id" for="x_u_id" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->u_id->CellAttributes() ?>>
...
<?php if ($ext_awake_info->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_awake_info_acl_id" for="x_acl_id" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->acl_id->CellAttributes() ?>>
...
<?php if ($ext_awake_info->title_______UNIQUE->Visible) { // title       UNIQUE ?>
	<div id="r_title_______UNIQUE" class="form-group">
		<label id="elh_ext_awake_info_title_______UNIQUE" for="x_title_______UNIQUE" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->title_______UNIQUE->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->title_______UNIQUE->CellAttributes() ?>>
...
<?php if ($ext_awake_info->baseTitle->Visible) { // baseTitle ?>
	<div id="r_baseTitle" class="form-group">
		<label id="elh_ext_awake_info_baseTitle" for="x_baseTitle" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->baseTitle->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->baseTitle->CellAttributes() ?>>
...
<?php if ($ext_awake_info->isEnable->Visible) { // isEnable ?>
	<div id="r_isEnable" class="form-group">
		<label id="elh_ext_awake_info_isEnable" for="x_isEnable" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->isEnable->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->isEnable->CellAttributes() ?>>
...
<?php if ($ext_awake_info->needGold->Visible) { // needGold ?>
	<div id="r_needGold" class="form-group">
		<label id="elh_ext_awake_info_needGold" for="x_needGold" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->needGold->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->needGold->CellAttributes() ?>>
...
<?php if ($ext_awake_info->needDiam->Visible) { // needDiam ?>
	<div id="r_needDiam" class="form-group">
		<label id="elh_ext_awake_info_needDiam" for="x_needDiam" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->needDiam->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->needDiam->CellAttributes() ?>>
...
<?php if ($ext_awake_info->needItem->Visible) { // needItem ?>
	<div id="r_needItem" class="form-group">
		<label id="elh_ext_awake_info_needItem" for="x_needItem" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->needItem->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->needItem->CellAttributes() ?>>
...
<?php if ($ext_awake_info->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_awake_info_DATETIME" for="x_DATETIME" class="<?php echo $ext_awake_info_add->LeftColumnClass ?>"><?php echo $ext_awake_info->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_awake_info_add->RightColumnClass ?>"><div<?php echo $ext_awake_info->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_awake_info_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_awake_info_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_awake_info_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_awake_infoadd.Init();
</script>
<?php
$ext_awake_info_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_awake_info_add->Page_Terminate();
?>

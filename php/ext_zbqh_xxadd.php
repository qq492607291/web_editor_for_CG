...
$ext_zbqh_xx_add = NULL; // Initialize page object first

class cext_zbqh_xx_add extends cext_zbqh_xx {
	...
	// Page object name
	var $PageObjName = 'ext_zbqh_xx_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ext_zbqh_xxview.php")
...
// Create page object
if (!isset($ext_zbqh_xx_add)) $ext_zbqh_xx_add = new cext_zbqh_xx_add();

// Page init
$ext_zbqh_xx_add->Page_Init();

// Page main
$ext_zbqh_xx_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ext_zbqh_xx_add->Page_Render();
?>
...
var CurrentForm = fext_zbqh_xxadd = new ew_Form("fext_zbqh_xxadd", "add");

// Validate form
fext_zbqh_xxadd.Validate = function() {
...
fext_zbqh_xxadd.Form_CustomValidate = 
...
fext_zbqh_xxadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ext_zbqh_xx_add->ShowPageHeader(); ?>
<?php
$ext_zbqh_xx_add->ShowMessage();
?>
<form name="fext_zbqh_xxadd" id="fext_zbqh_xxadd" class="<?php echo $ext_zbqh_xx_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ext_zbqh_xx_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ext_zbqh_xx_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ext_zbqh_xx">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($ext_zbqh_xx_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($ext_zbqh_xx->u_id->Visible) { // u_id ?>
	<div id="r_u_id" class="form-group">
		<label id="elh_ext_zbqh_xx_u_id" for="x_u_id" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->u_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->u_id->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->acl_id->Visible) { // acl_id ?>
	<div id="r_acl_id" class="form-group">
		<label id="elh_ext_zbqh_xx_acl_id" for="x_acl_id" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->acl_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->acl_id->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group">
		<label id="elh_ext_zbqh_xx_Name" for="x_Name" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->Name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->Name->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->LV->Visible) { // LV ?>
	<div id="r_LV" class="form-group">
		<label id="elh_ext_zbqh_xx_LV" for="x_LV" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->LV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->LV->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->XHJB->Visible) { // XHJB ?>
	<div id="r_XHJB" class="form-group">
		<label id="elh_ext_zbqh_xx_XHJB" for="x_XHJB" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->XHJB->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->XHJB->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->XHZS->Visible) { // XHZS ?>
	<div id="r_XHZS" class="form-group">
		<label id="elh_ext_zbqh_xx_XHZS" for="x_XHZS" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->XHZS->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->XHZS->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->XHWP->Visible) { // XHWP ?>
	<div id="r_XHWP" class="form-group">
		<label id="elh_ext_zbqh_xx_XHWP" for="x_XHWP" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->XHWP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->XHWP->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->ADDSX->Visible) { // ADDSX ?>
	<div id="r_ADDSX" class="form-group">
		<label id="elh_ext_zbqh_xx_ADDSX" for="x_ADDSX" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->ADDSX->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->ADDSX->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->SuccessV->Visible) { // SuccessV ?>
	<div id="r_SuccessV" class="form-group">
		<label id="elh_ext_zbqh_xx_SuccessV" for="x_SuccessV" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->SuccessV->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->SuccessV->CellAttributes() ?>>
...
<?php if ($ext_zbqh_xx->DATETIME->Visible) { // DATETIME ?>
	<div id="r_DATETIME" class="form-group">
		<label id="elh_ext_zbqh_xx_DATETIME" for="x_DATETIME" class="<?php echo $ext_zbqh_xx_add->LeftColumnClass ?>"><?php echo $ext_zbqh_xx->DATETIME->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ext_zbqh_xx_add->RightColumnClass ?>"><div<?php echo $ext_zbqh_xx->DATETIME->CellAttributes() ?>>
...
<?php if (!$ext_zbqh_xx_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ext_zbqh_xx_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ext_zbqh_xx_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fext_zbqh_xxadd.Init();
</script>
<?php
$ext_zbqh_xx_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ext_zbqh_xx_add->Page_Terminate();
?>

...
$config_composite = NULL;

//
// Table class for config_composite
//
class cconfig_composite extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Produce;
	...
	function __construct() {
		...
		$this->TableVar = 'config_composite';
		$this->TableName = 'config_composite';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`config_composite`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('config_composite', 'config_composite', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('config_composite', 'config_composite', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('config_composite', 'config_composite', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Produce
		$this->Produce = new cField('config_composite', 'config_composite', 'x_Produce', 'Produce', '`Produce`', '`Produce`', 201, -1, FALSE, '`Produce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Produce->Sortable = TRUE; // Allow sort
		$this->fields['Produce'] = &$this->Produce;

		// ConsumeGoods
		$this->ConsumeGoods = new cField('config_composite', 'config_composite', 'x_ConsumeGoods', 'ConsumeGoods', '`ConsumeGoods`', '`ConsumeGoods`', 201, -1, FALSE, '`ConsumeGoods`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ConsumeGoods->Sortable = TRUE; // Allow sort
		$this->fields['ConsumeGoods'] = &$this->ConsumeGoods;

		// ConsumeGold
		$this->ConsumeGold = new cField('config_composite', 'config_composite', 'x_ConsumeGold', 'ConsumeGold', '`ConsumeGold`', '`ConsumeGold`', 201, -1, FALSE, '`ConsumeGold`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ConsumeGold->Sortable = TRUE; // Allow sort
		$this->fields['ConsumeGold'] = &$this->ConsumeGold;

		// ConsumeDiamond
		$this->ConsumeDiamond = new cField('config_composite', 'config_composite', 'x_ConsumeDiamond', 'ConsumeDiamond', '`ConsumeDiamond`', '`ConsumeDiamond`', 201, -1, FALSE, '`ConsumeDiamond`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ConsumeDiamond->Sortable = TRUE; // Allow sort
		$this->fields['ConsumeDiamond'] = &$this->ConsumeDiamond;

		// Success
		$this->Success = new cField('config_composite', 'config_composite', 'x_Success', 'Success', '`Success`', '`Success`', 201, -1, FALSE, '`Success`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Success->Sortable = TRUE; // Allow sort
		$this->fields['Success'] = &$this->Success;

		// DATETIME
		$this->DATETIME = new cField('config_composite', 'config_composite', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`config_composite`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "config_compositelist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "config_compositeedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "config_compositeadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("config_compositeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("config_compositeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "config_compositeadd.php?" . $this->UrlParm($parm);
		else
			$url = "config_compositeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("config_compositeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("config_compositeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("config_compositedelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->Produce->setDbValue($rs->fields('Produce'));
		$this->ConsumeGoods->setDbValue($rs->fields('ConsumeGoods'));
		$this->ConsumeGold->setDbValue($rs->fields('ConsumeGold'));
		$this->ConsumeDiamond->setDbValue($rs->fields('ConsumeDiamond'));
	...
	function RenderEditRow() {
		...
		$this->Produce->EditValue = $this->Produce->CurrentValue;
		...
		$this->ConsumeGoods->EditValue = $this->ConsumeGoods->CurrentValue;
		...
		$this->ConsumeGold->EditValue = $this->ConsumeGold->CurrentValue;
		...
		$this->ConsumeDiamond->EditValue = $this->ConsumeDiamond->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->Produce->Exportable) $Doc->ExportCaption($this->Produce);
					if ($this->ConsumeGoods->Exportable) $Doc->ExportCaption($this->ConsumeGoods);
					if ($this->ConsumeGold->Exportable) $Doc->ExportCaption($this->ConsumeGold);
					if ($this->ConsumeDiamond->Exportable) $Doc->ExportCaption($this->ConsumeDiamond);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->Produce->Exportable) $Doc->ExportField($this->Produce);
						if ($this->ConsumeGoods->Exportable) $Doc->ExportField($this->ConsumeGoods);
						if ($this->ConsumeGold->Exportable) $Doc->ExportField($this->ConsumeGold);
						if ($this->ConsumeDiamond->Exportable) $Doc->ExportField($this->ConsumeDiamond);

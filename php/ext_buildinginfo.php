...
//
// Table class for ext_building
//
class cext_building extends cTable {
	var $unid;
	var $u_id;
	var $acl_id;
	var $Name;
	...
	function __construct() {
		...
		$this->TableVar = 'ext_building';
		$this->TableName = 'ext_building';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ext_building`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// unid
		$this->unid = new cField('ext_building', 'ext_building', 'x_unid', 'unid', '`unid`', '`unid`', 3, -1, FALSE, '`unid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->unid->Sortable = TRUE; // Allow sort
		$this->unid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unid'] = &$this->unid;

		// u_id
		$this->u_id = new cField('ext_building', 'ext_building', 'x_u_id', 'u_id', '`u_id`', '`u_id`', 3, -1, FALSE, '`u_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->u_id->Sortable = TRUE; // Allow sort
		$this->u_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['u_id'] = &$this->u_id;

		// acl_id
		$this->acl_id = new cField('ext_building', 'ext_building', 'x_acl_id', 'acl_id', '`acl_id`', '`acl_id`', 3, -1, FALSE, '`acl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new cField('ext_building', 'ext_building', 'x_Name', 'Name', '`Name`', '`Name`', 201, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// unionName
		$this->unionName = new cField('ext_building', 'ext_building', 'x_unionName', 'unionName', '`unionName`', '`unionName`', 201, -1, FALSE, '`unionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->unionName->Sortable = TRUE; // Allow sort
		$this->fields['unionName'] = &$this->unionName;

		// Location
		$this->Location = new cField('ext_building', 'ext_building', 'x_Location', 'Location', '`Location`', '`Location`', 201, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Function
		$this->Function = new cField('ext_building', 'ext_building', 'x_Function', 'Function', '`Function`', '`Function`', 201, -1, FALSE, '`Function`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Function->Sortable = TRUE; // Allow sort
		$this->fields['Function'] = &$this->Function;

		// Dialog
		$this->Dialog = new cField('ext_building', 'ext_building', 'x_Dialog', 'Dialog', '`Dialog`', '`Dialog`', 201, -1, FALSE, '`Dialog`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Dialog->Sortable = TRUE; // Allow sort
		$this->fields['Dialog'] = &$this->Dialog;

		// Introduce
		$this->Introduce = new cField('ext_building', 'ext_building', 'x_Introduce', 'Introduce', '`Introduce`', '`Introduce`', 201, -1, FALSE, '`Introduce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Introduce->Sortable = TRUE; // Allow sort
		$this->fields['Introduce'] = &$this->Introduce;

		// Trigger
		$this->Trigger = new cField('ext_building', 'ext_building', 'x_Trigger', 'Trigger', '`Trigger`', '`Trigger`', 201, -1, FALSE, '`Trigger`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Trigger->Sortable = TRUE; // Allow sort
		$this->fields['Trigger'] = &$this->Trigger;

		// TR_Limit
		$this->TR_Limit = new cField('ext_building', 'ext_building', 'x_TR_Limit', 'TR_Limit', '`TR_Limit`', '`TR_Limit`', 201, -1, FALSE, '`TR_Limit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->TR_Limit->Sortable = TRUE; // Allow sort
		$this->fields['TR_Limit'] = &$this->TR_Limit;

		// DATETIME
		$this->DATETIME = new cField('ext_building', 'ext_building', 'x_DATETIME', 'DATETIME', '`DATETIME`', ew_CastDateFieldForLike('`DATETIME`', 0, "DB"), 135, 0, FALSE, '`DATETIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ext_building`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ext_buildingedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ext_buildingadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ext_buildingview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ext_buildingview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ext_buildingadd.php?" . $this->UrlParm($parm);
		else
			$url = "ext_buildingadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ext_buildingedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ext_buildingadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ext_buildingdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->unionName->setDbValue($rs->fields('unionName'));
		...
		$this->Trigger->setDbValue($rs->fields('Trigger'));
		$this->TR_Limit->setDbValue($rs->fields('TR_Limit'));
	...
	function RenderEditRow() {
		...
		$this->unionName->EditValue = $this->unionName->CurrentValue;
		...
		$this->Trigger->EditValue = $this->Trigger->CurrentValue;
		...
		$this->TR_Limit->EditValue = $this->TR_Limit->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->unionName->Exportable) $Doc->ExportCaption($this->unionName);
					...
					if ($this->Trigger->Exportable) $Doc->ExportCaption($this->Trigger);
					if ($this->TR_Limit->Exportable) $Doc->ExportCaption($this->TR_Limit);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->unionName->Exportable) $Doc->ExportField($this->unionName);
						...
						if ($this->Trigger->Exportable) $Doc->ExportField($this->Trigger);
						if ($this->TR_Limit->Exportable) $Doc->ExportField($this->TR_Limit);

...
$config_decomposition_view = NULL; // Initialize page object first

class cconfig_decomposition_view extends cconfig_decomposition {
	...
	// Page object name
	var $PageObjName = 'config_decomposition_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["unid"] <> "") {
				...
				$sReturnUrl = "config_decompositionlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "config_decompositionlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "config_decompositionlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($config_decomposition_view)) $config_decomposition_view = new cconfig_decomposition_view();

// Page init
$config_decomposition_view->Page_Init();

// Page main
$config_decomposition_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$config_decomposition_view->Page_Render();
?>
...
var CurrentForm = fconfig_decompositionview = new ew_Form("fconfig_decompositionview", "view");

// Form_CustomValidate event
fconfig_decompositionview.Form_CustomValidate = 
...
fconfig_decompositionview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $config_decomposition_view->ExportOptions->Render("body") ?>
<?php
	foreach ($config_decomposition_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $config_decomposition_view->ShowPageHeader(); ?>
<?php
$config_decomposition_view->ShowMessage();
?>
<form name="fconfig_decompositionview" id="fconfig_decompositionview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($config_decomposition_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $config_decomposition_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="config_decomposition">
<input type="hidden" name="modal" value="<?php echo intval($config_decomposition_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($config_decomposition->unid->Visible) { // unid ?>
	<tr id="r_unid">
		<td class="col-sm-2"><span id="elh_config_decomposition_unid"><?php echo $config_decomposition->unid->FldCaption() ?></span></td>
		<td data-name="unid"<?php echo $config_decomposition->unid->CellAttributes() ?>>
<span id="el_config_decomposition_unid">
<span<?php echo $config_decomposition->unid->ViewAttributes() ?>>
<?php echo $config_decomposition->unid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->u_id->Visible) { // u_id ?>
	<tr id="r_u_id">
		<td class="col-sm-2"><span id="elh_config_decomposition_u_id"><?php echo $config_decomposition->u_id->FldCaption() ?></span></td>
		<td data-name="u_id"<?php echo $config_decomposition->u_id->CellAttributes() ?>>
<span id="el_config_decomposition_u_id">
<span<?php echo $config_decomposition->u_id->ViewAttributes() ?>>
<?php echo $config_decomposition->u_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->acl_id->Visible) { // acl_id ?>
	<tr id="r_acl_id">
		<td class="col-sm-2"><span id="elh_config_decomposition_acl_id"><?php echo $config_decomposition->acl_id->FldCaption() ?></span></td>
		<td data-name="acl_id"<?php echo $config_decomposition->acl_id->CellAttributes() ?>>
<span id="el_config_decomposition_acl_id">
<span<?php echo $config_decomposition->acl_id->ViewAttributes() ?>>
<?php echo $config_decomposition->acl_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->Goods->Visible) { // Goods ?>
	<tr id="r_Goods">
		<td class="col-sm-2"><span id="elh_config_decomposition_Goods"><?php echo $config_decomposition->Goods->FldCaption() ?></span></td>
...
<?php echo $config_decomposition->Goods->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->NeedG->Visible) { // NeedG ?>
	<tr id="r_NeedG">
		<td class="col-sm-2"><span id="elh_config_decomposition_NeedG"><?php echo $config_decomposition->NeedG->FldCaption() ?></span></td>
...
<?php echo $config_decomposition->NeedG->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->NeedD->Visible) { // NeedD ?>
	<tr id="r_NeedD">
		<td class="col-sm-2"><span id="elh_config_decomposition_NeedD"><?php echo $config_decomposition->NeedD->FldCaption() ?></span></td>
...
<?php echo $config_decomposition->NeedD->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->GetGoods->Visible) { // GetGoods ?>
	<tr id="r_GetGoods">
		<td class="col-sm-2"><span id="elh_config_decomposition_GetGoods"><?php echo $config_decomposition->GetGoods->FldCaption() ?></span></td>
...
<?php echo $config_decomposition->GetGoods->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->Success->Visible) { // Success ?>
	<tr id="r_Success">
		<td class="col-sm-2"><span id="elh_config_decomposition_Success"><?php echo $config_decomposition->Success->FldCaption() ?></span></td>
...
<?php echo $config_decomposition->Success->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($config_decomposition->DATETIME->Visible) { // DATETIME ?>
	<tr id="r_DATETIME">
		<td class="col-sm-2"><span id="elh_config_decomposition_DATETIME"><?php echo $config_decomposition->DATETIME->FldCaption() ?></span></td>
...
<?php echo $config_decomposition->DATETIME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fconfig_decompositionview.Init();
</script>
<?php
$config_decomposition_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$config_decomposition_view->Page_Terminate();
?>
